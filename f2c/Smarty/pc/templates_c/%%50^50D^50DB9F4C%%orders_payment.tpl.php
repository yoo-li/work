<?php /* Smarty version 2.6.18, created on 2017-06-13 16:21:13
         compiled from orders_payment.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
<meta charset="utf-8">
    ...
    $.ajax({
      ...
      success: function callbackFun(data) {
        ...
        if (info.code == 200) {
          ...
          $(\'.confirmreceipt\').each(function(){
            $(this).click(function(){
              var orderid = $(this).attr(\'data-id\');
              if(confirm(\'您确定已经收到此商品吗？\')){
  ...
  function product_html(v) { 
    ...
    if (v.aftersaleservicestatus != \'yes\')
    {
      if (v.order_status != "退货中" && v.order_status != "已退货" && v.order_status != "已退款" && v.order_status != "已付款")
      {
        ...
        {
          sb.append(\'<td width="11%"><p class="mb-5"><a href="javascript:;" class="btn btn-danger btn-sm btn-p10 confirmreceipt">确认收货</a></p>\');
          ...
          {
            sb.append(\'<td width="11%"><p class="mb-5"><a href="appraise_submit.php?record=\' + v.orderid + \'" class="btn btn-danger btn-sm btn-p10">查看评价</a></p>\');
            sb.append(\'<p class="text-center"><a class="deleteorder" href="aftersaleservice.php?record=\' + v.orderid + \'">售后服务</a></p></td>\');
          }else{
        ...
        sb.append(\'<td width="11%"><p class="mb-5"><a href="aftersaleservice.php?record=\' + v.orderid + \'" class="btn btn-danger btn-sm btn-p10">售后服务</a></p>\');
        sb.append(\'</td>\');
      }
    }else{
        sb.append(\'<td width="11%"><p class="mb-5"><a href="aftersaleservice.php?record=\' + v.orderid + \'" class="btn btn-danger btn-sm btn-p10">售后服务</a></p>\');
