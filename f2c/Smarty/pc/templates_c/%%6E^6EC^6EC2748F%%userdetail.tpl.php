<?php /* Smarty version 2.6.18, created on 2017-06-23 13:09:28
              ...
              <div class="findKey-form-box">
                <ul class="findKey-form clearfix" style="margin:41px 0 40px 100px; width:700px;">
                  <li><span>昵称：</span>
                    <div>
                       <p>
                        <input type="text" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['givenname']; ?>
" disabled>
                      </p>
                    </div>
                  </li>
                  <li><span>等级：<em class="red mr-10"><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?></em></span>
                  ...
                  <li><span>店铺：</span>
                    <div>
                      <p>
                        <input type="text" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['physicalstorename']; ?>
" disabled> 
                      </p>
                    </div>
                  </li>
                  <li><span>店员：</span>
                    <div>
                      <p>
                        <input type="text" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['assistantprofile']; ?>
" disabled> 
                      </p>
                    </div>
                  </li>
					<?php else: ?>
	                    <?php if ($this->_tpl_vars['profile_info']['onelevelsourcer'] != ''): ?>
	                    	<li><span>您的推荐人：</span>
			                    <div>
			                      <p>
			                        <input type="text" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['sourcergivename']; ?>
" disabled> 
			                      </p>
			                    </div>
			                  </li>
                  ...
                  <li><span>手机号：</span>
                    <div>
                      <p>
                        <input type="text" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['mobile']; ?>
">
                  ...
                  <li><span>地区：</span>
                    <div>
                      <p>
                        <input type="text" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['province']; ?>
...
" disabled>
                  ...
                  <li> <span>性别：</span>
                    <div>
                      <input type="text" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['gender']; ?>
" disabled>
                    </div>
                  </li>
                  <!-- <li> <span>所在地：</span>
                ...
                <div class="select_box"><div class="select_showbox" style="cursor: pointer;">请选择市</div><ul class="select_option"><li class="selected" style="cursor: pointer;">请选择市</li><li style="cursor: pointer;">Saab</li><li style="cursor: pointer;">Opel</li></ul></div><select class="select border gray-c">
                  ...
                  <li class="breath"><span>生日：</span>
                    <div>
                      <p>
                        <input type="text" id="calOne" class="text w400 gray-c" value="<?php echo $this->_tpl_vars['profile_info']['birthdate']; ?>
" disabled>
                      </p>
                    </div>
                  </li>
