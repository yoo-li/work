<?php /* Smarty version 2.6.18, created on 2017-06-13 16:20:59
 ...
 ?>
        ...
        <div class="person-right pull-right mui-inner-wrap">
          <div class="person-jj bg-f5 border clearfix">
            <div class="person-jj-l pull-left"> <img src="<?php echo $this->_tpl_vars['profile_info']['headimgurl']; ?>
" width="100" height="100"> </div>
            <div class="person-jj-m pull-left">
              <h4 class="f14 red"><?php echo $this->_tpl_vars['profile_info']['givenname']; ?>
</h4>
              <p class="clearfix hui">您好，欢迎来到<?php echo $this->_tpl_vars['supplier_info']['suppliername']; ?>
</p>
          ...
          <div class="person-dj border">
            <div class="person-dj-tit person-dian"> <a href="orders_payment.php" class="pull-right">查看全部订单 ></a>
              ...
              <ul>
                <li><a href="orders_pendingpayment.php" class="red">待付款<span>(<?php if ($this->_tpl_vars['badges']['pendingpayment'] > 0): ?><?php echo $this->_tpl_vars['badges']['pendingpayment']; ?>
<?php endif; ?>)</span></a>|</li>
                <li><a href="orders_sendout.php">待发货<span >(<?php echo $this->_tpl_vars['badges']['nosend']; ?>
)</span></a>|</li>
                <li><a href="orders_receipt.php">待收货<span >(<?php echo $this->_tpl_vars['badges']['receipt']; ?>
)</span></a>|</li>
                <li><a href="orders_appraise.php">待评价<span>(<?php echo $this->_tpl_vars['badges']['appraise']; ?>
)</span></a></li>
              </ul>
            </div>
            <div id="tabbox">
