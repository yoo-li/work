<?php /* Smarty version 2.6.18, created on 2017-06-23 16:52:13
    ...
    <div class="container">
      ...
      <div class="productbox">
        ...
        <div class="product-body Recent-body clearfix">
          ...
          <input id="categoryid"  type="hidden" value="<?php echo $this->_tpl_vars['categoryid']; ?>
">
          <input id="keywords"  type="hidden" value="<?php echo $this->_tpl_vars['keywords']; ?>
">
