<?php /* Smarty version 2.6.18, created on 2017-06-23 13:55:14
         compiled from orders_sendout.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
<meta charset="utf-8">
          ...
          <div class="person-dj border bn">
            <div class="person-post-tit person-linetit">
              ...
              <ul class="pull-left">
                ...
                <li><a href="orders_sendout.php" class="active">待发货</a>|</li>
...
//分页查询 
  ...
  function product_html(v) { 
    ...
    sb.append(\'<td width="11%"><p class="mb-5"><a class="btn btn-danger btn-sm btn-p10" href="javascript:;">等待商家发货</a></p>\');
    sb.append(\'<p class="text-center"><a href="aftersaleservice.php?record=\' + v.orderid + \'"  class="deleteorder">售后服务</a></p></td>\');
    sb.append(\'</tr>\');
    sb.append(\'</tbody>\');
    sb.append(\'</table>\');
    sb.append(\'</div>\');
