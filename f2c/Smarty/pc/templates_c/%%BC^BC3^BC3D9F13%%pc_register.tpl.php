<?php /* Smarty version 2.6.18, created on 2017-06-23 13:58:03
         compiled from pc_register.tpl */ ?>
<!DOCTYPE html>
<html lang='zh-cn' class='m-user m-user-register'>
<head> 
    <title>注册 - <?php echo $this->_tpl_vars['supplier_info']['suppliername']; ?>
</title>
    <meta name="keywords" content="注册 - <?php echo $this->_tpl_vars['supplier_info']['suppliername']; ?>
">
    <meta name="description" content="注册 - <?php echo $this->_tpl_vars['supplier_info']['suppliername']; ?>
">
	
	<script>
	    <?php echo '  
		var config={"webRoot":"\\/","cookieLife":30,"requestType":"PATH_INFO","requestFix":"-","moduleVar":"m","methodVar":"f","viewVar":"t","defaultView":"html","themeRoot":"\\/theme\\/","currentModule":"user","currentMethod":"register","clientLang":"zh-cn","requiredFields":"account,realname,email,password1","save":"\\u4fdd\\u5b58","router":"\\/index.php","runMode":"front","langCode":""}
		if(typeof(v) != "object") 
			v = {};
