<?php /* Smarty version 2.6.18, created on 2017-06-23 13:55:47
         compiled from pc_login.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-cn">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="warp" class="loginwarp">
            ...
            <div class="cont">
                <div class="container">
                    <!--登录 开始--> 
                        <input type="hidden" name="post_token" value='<?php echo $this->_tpl_vars['post_token']; ?>
'> 
                                ...
                                <div class="pull-left login-form" style="margin-left:200px;padding-bottom:35px;">
                                    <div class="m-lr10">
                                        <h3 class="font-14 m-b30" style='text-align:center;'>
                                            ...
                                            <?php if ($this->_tpl_vars['safeinfo'] == 'true'): ?>
                                                <font color='red'><br><br>(为了您的帐户安全，请重新登录)</font>
                                            <?php endif; ?>
                                            <?php if ($this->_tpl_vars['login_info'] != ""): ?>
                                                <font color='red'><br><br>&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['login_info']; ?>
</font>
                                            <?php endif; ?>
                                        </h3>
