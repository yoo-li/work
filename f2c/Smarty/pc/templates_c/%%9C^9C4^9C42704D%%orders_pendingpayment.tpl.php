<?php /* Smarty version 2.6.18, created on 2017-06-23 14:28:25
          ...
          <div class="person-dj border bn">
            <div class="person-post-tit person-linetit">
              ...
              <ul class="pull-left">
                ...
                <li><a href="orders_pendingpayment.php" class="active">待付款</a>|</li>
...
//分页查询 
  ...
  function product_html(v) { 
    ...
    sb.append(\'<td width="11%"><p class="mb-5"><a href="submitorder.php?record=\'+ v.orderid +\'" class="btn btn-danger btn-sm btn-p10">去付款</a></p>\');
