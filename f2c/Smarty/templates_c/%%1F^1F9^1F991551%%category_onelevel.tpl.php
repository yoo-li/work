<?php /* Smarty version 2.6.18, created on 2017-08-25 14:30:09
         compiled from category_onelevel.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	...
	<?php if ($this->_tpl_vars['supplier_info']['categoryscolumns'] == '2'): ?>
	<?php echo '
...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php if ($this->_tpl_vars['supplier_info']['themecolor'] != ''): ?>
		<style>
		<!--
		    #pullrefresh .mui-table-view.mui-grid-view .mui-table-view-cell { background-color:<?php echo $this->_tpl_vars['supplier_info']['productbackgroundcolor']; ?>
;  }
			#pullrefresh .mui-table-view.mui-grid-view .mui-table-view-cell .mui-media-body { color: <?php echo $this->_tpl_vars['supplier_info']['textcolor']; ?>
; }
			<?php if ($this->_tpl_vars['supplier_info']['themecolor'] == $this->_tpl_vars['supplier_info']['buttoncolor']): ?>
			 	.special-button-color {  color: #fff;  }
			<?php else: ?>
			 	.special-button-color {  color: <?php echo $this->_tpl_vars['supplier_info']['buttoncolor']; ?>
;  }
			<?php endif; ?>
			#pullrefresh .mui-table-view.mui-grid-view .mui-table-view-cell .price2 {  color: <?php echo $this->_tpl_vars['supplier_info']['productpricecolor']; ?>
;  }
		-->
		</style>
	<?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
             <div id="pullrefresh" class="mui-content mui-scroll-wrapper" style="padding-top: 80px;">
                 <div class="mui-scroll">
						  ...
						  <input id="categoryid" name="categoryid" type="hidden" value="<?php echo $this->_tpl_vars['categoryid']; ?>
">
						  <input id="categoryscolumns"  value="<?php echo $this->_tpl_vars['supplier_info']['categoryscolumns']; ?>
" type="hidden">
	                      <ul id="list" class="mui-table-view list">
 							 <div class="mui-table-view  mui-pull-left" style="width:30%;" >
 		 							 <ul id="categorys_list" class="mui-table-view">
 					                    <?php $_from = $this->_tpl_vars['categorys']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['categorys'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['categorys']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['v']):
        $this->_foreach['categorys']['iteration']++;
?>
 			 								<li class="mui-table-view-cell mui-media main-category <?php if ($this->_foreach['categorys']['iteration'] > 1): ?>category-view-cell<?php endif; ?>">
 			 									<a class="mui-navigate-right" data-id="<?php echo $this->_tpl_vars['v']['id']; ?>
" href="javascript:;">
 			 										 <div class="mui-media-body"><?php echo $this->_tpl_vars['v']['name']; ?>
</div>
 			 									</a>
 			 								</li>
...
function category_html(v,categoryscolumns) {
   		  ...
   		  if (categoryscolumns == "2")
   		  {
				 ...
				 if (v.hasproperty == \'1\')
				 {
				 		sb.append(\'                         <li class="wg3"><a  href="company_detail.php?from=index&productid=\'+v.productid+\'"><span class="mui-icon iconfont icon-xinzeng special-button-color" style="font-size: 1.8em;"></span></a> </li>\');
			 	 }
				 else
				 {
  ...
  function product_singlerow_classic_html(v) {
	   var sb=new StringBuilder();
		 ...
		 if (v.hasproperty == "1")
		 {
			 sb.append(\'<a class="mui-navigate-right" href="company_detail.php?from=index&productid=\'+v.productid+\'">\');
		 ...
		 else
		 {
			  sb.append(\'<a class="mui-navigate-right" href="javascript:;">\');
	 		  sb.append(\'       <img data-url="company_detail.php?from=index&productid=\'+v.productid+\'" class="lazy mui-media-object mui-pull-left detailimage" id="product_item_\'+v.productid+\'" src="images/smkLoad.png" data-lazyload="\'+v.productlogo+\'">\');
