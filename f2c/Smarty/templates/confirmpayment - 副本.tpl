	...
	<div class="mui-inner-wrap">
		...
		<nav class="mui-bar mui-bar-tab" style="height:40px;line-height:40px;">
			<a id="confirmpayment" class="mui-tab-item mui-active confirmpayment" href="#" style="width:30%">
				<span class="mui-icon iconfont icon-qian button-color" id="payment_icon" style="top:0px;"></span><span id="payment_button">确定支付</span>
			</a>
		</nav>
			...
			<div class="mui-scroll">
				...
				<div class="mui-card" style="margin: 0 3px 5px 3px;">
					<ul class="mui-table-view">
						...
						<li class="mui-table-view-cell">
							<div class="mui-media-body  mui-pull-left">
								<span class="mui-table-view-label">总金额： </span><span class="totalprice">￥<b><span style="font-size: 16px;">{$total_money}</span></b></span>
							</div>
						</li>
						<div id="paymentgroup">
							...
							<li class="mui-table-view-cell" id="paymentwaygroup">
								...
								<div class="yanse_xz mui-pull-left" id="radiogroup">
									{if $official eq 'true'}
										<a class="btn btn-default radiogroup" groupid="payment" paymentway="official" href="javascript:;" >
											<span class="mui-icon iconfont icon-kongxinshiwuguan" style="font-size: 3.5em;"></span>
											<div style="display:none">
												<input class="paymentway" id="official" type="radio" name="paymentway" value="official" />
											</div>
										</a>
									{/if}
									{if $supplier_info.supplierid eq '71352' || $supplier_info.supplierid eq '12352'}
									<div class="mui-pull-left mgrg25">
										<a class="btn btn-default radiogroup" groupid="payment" paymentway="wxsmk" href="javascript:;" >
											<span class="mui-icon iconfont icon-huiminshangchenglogo" style="font-size: 3.5em;"></span>
											<div style="display:none">
							...
							<li id="wxsmk_cardno_div" class="mui-table-view-cell" style="display:none;" >
								<div class="mui-media-body  mui-pull-left">
							...
							<li id="wxsmk_password_div" class="mui-table-view-cell" style="display:none;">
								<div class="mui-media-body  mui-pull-left">
...
//		if (Zepto('#usemoney').prop('checked'))
	...
	function confirmpayment()
	{
		...
		var postbody = 'orderid=' + orderid + '&paymentway=' + paymentway + '&usemoney=' + usemoney + '&needpayable=' + needpayable + '&vipcardusageid=' + vipcardusageid + '&vipcardusageamount=' + vipcardusageamount;
	    if (paymentway == "wxsmk")
	    {
