        ...
        <ul class="mui-table-view mui-grid-view mui-grid-9">
            ...
            <li class="mui-table-view-cell mui-media mui-col-xs-2">
                <a href="/shoppingcart.php" class="shoppingcart" id="gouwuche">
					<span class="mui-icon icon"  id="shoppingcart" style="font-size: 20px;">
                        <span id="shoppingcart_badge" >{if $share_info.shoppingcart neq '0' && $share_info.shoppingcart neq '' }
                            <span class="mui-badge mui-badge-red" >{$share_info.shoppingcart}
                            </span>{/if}&#xe64f;
                        </span>
                    </span>
            ...
            <div class="mui-content-padded goods-content"  id="propertygroup">
                ...
                <div id="goods" class="mui-control-content mui-active">
                        ...
                        <div class="goods-price">
                            {if $productinfo.activityname neq '' &&  $productinfo.zhekoulabel neq '' && $productinfo.zhekou neq ''}
                                {if $productinfo.activitymode eq '1'}
                                    <span class="price" style="color: #f23030;">￥{$productinfo.total_money}</span>
                                {else}
                                    <span class="price" style="color: #f23030;">￥{$productinfo.total_money}</span>
                                {/if}

                            {else}
                                <span class="price">￥{$productinfo.shop_price}</span>
                            {/if}
                    ...
                    {if $productinfo.activityname neq '' &&  $productinfo.zhekoulabel neq '' && $productinfo.zhekou neq ''}
                        {if $productinfo.activitymode eq '1'}
                            <div class="mui-row wrap">
                                <div class="t-left mui-pull-left">砍价活动：</div>
                                <div class="t-right mui-pull-left">
                                    <p><span > {$productinfo.activityname}</span></p>
                                </div>
                            ...
                            {if $productinfo.bargains|@count gt '0'}
                                <div class="mui-row wrap">
                                    <div class="t-left mui-pull-left"></div>
                                    <div class="t-right mui-pull-left">
                    ...
                    {if $productinfo.vendorname neq '' && $supplier_info.showvendor eq '1'}
                        <div class="mui-row wrap">
                            <div class="t-left mui-pull-left">供应商：</div>
                            <div class="t-right mui-pull-left">
                    ...
                    {/if}
                    <div class="mui-row wrap">
                        <div class="t-left mui-pull-left">库存数量：</div>
                        <div class="t-right mui-pull-left">
                            {if $jd eq '1'}
                                <p><span id="inventory_label"> </span>{if $productinfo.inventory eq '0'}无货{else}有货{/if}</p>
                            {else}
                                <p><span id="inventory_label"> {$productinfo.inventory}</span>&nbsp;件</p>
                            {/if}
                    ...
                    <!-- 商品信息 -->
                    <div class="mui-row wrap">
                        <div class="t-left mui-pull-left">已选：</div>
                        <div class="t-right mui-pull-left">
                            ...
                            <div class="mui-row">
                                ...
                                <div class="mui-pull-right tags clear">
                                    <div class="mui-numbox" data-numbox-step='1' data-numbox-min='1' data-numbox-max='100'>
                                        ...
                                        <input class="mui-numbox-input" type="number" onkeyup="recalc();" readonly   id="qty_item" name="qty_item"/>
            ...
            mui.ajax({
                ...
                success: function(json) {
                    ...
                    if (jsondata.code == 200) {
                        mui.toast(jsondata.msg);
                        flyItem("productlogo");
                        Zepto('#shoppingcart_badge').html('<span class="mui-badge mui-badge-red" >'+jsondata.shoppingcart+'</span>&#xe64f;');
                    }
                    else
                    {
                        mui.toast(jsondata.msg);
