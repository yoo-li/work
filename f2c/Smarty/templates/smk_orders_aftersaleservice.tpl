		...
		<header class="mui-bar mui-bar-nav mui-row myorder_header">
			...
			<div class="mui-bar mui-title" style="margin-top: 40px;right: 0;left: 0;">
				<div id="segmentedControl" class="myorder_list_hd mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
					<a href="smk_orders_pendingpayment.php" class="mui-control-item ">待付款</a>
					...
					<a href="smk_orders_aftersaleservice.php" class="mui-control-item mui-active">售后服务</a>
				</div>
			</div>
		</header>
...
<script type="text/javascript" charset="utf-8">
	...
	function order_empty_html()
	{
		...
		sb.append('					      <p class="msgbody">您的货已付款订单还是空的，快去选购商品吧<br>');
	...
	function add_more()
	{
		...
		mui.ajax({
			type: 'POST',
			url: "orders.ajax.php",
			data: 'type=aftersaleservice&page=' + page,
