    ...
    <nav class="mui-bar mui-bar-tab bottom">
        <ul class="mui-table-view mui-grid-view mui-grid-9" style="height:100%">
            {if $productinfo.activityname neq '' &&  $productinfo.zhekoulabel neq '' && $productinfo.zhekou neq ''}
                ...
                <li class="mui-table-view-cell mui-media mui-col-xs-3 add-cart" id="add_miaosha_cart"  >
                    <a href="#" class="addshoppingcart" id = "check_purchase"  >
                        <a href="#"   id = "check_purchase">
                            加入购物车
                        </a>
                </li>
                token 值
                ...
                <input readonly data-id="{$shoppingcart_info.id}" value="{$shoppingcart_info.quantity}"
                       ...
                       class="mui-numbox-input" type="hidden"/>
