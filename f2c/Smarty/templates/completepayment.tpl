...
<head>
    ...
    <style>
        ...
        .totalprice {color:red; font-size:1.2em; font-weight:500; }
...
<div class="mui-off-canvas-wrap mui-draggable" id="offCanvasWrapper">
    <div class="mui-inner-wrap">
        <header class="mui-bar mui-bar-nav" style="padding-right: 15px;background-color: #f9f9f9;">
            ...
            <h1 class="mui-title" id="pagetitle" style="color: #232326;">
            ...
            <div class="mui-scroll">
                <div class="mui-card" style="margin: 0 3px;">
                    ...
                    <ul class="mui-table-view">
                        ...
                        {else}
                            {if $orderinfo.paymentway eq 'official'}
                                <li class="mui-table-view-cell" id="paymentsuccess-wrap" style="display:none;" >
                                    <div class="mui-media-object mui-pull-left"><span class="mui-icon iconfont icon-dingdanchenggong icon-paymentsuccess"></span></div>
                                    <div class="mui-media-body">
                                        <p class='mui-ellipsis' style="color:#333">{$businesse_info.businessename}恭喜您: </p>
                                        <p class='mui-ellipsis paymentsuccess'>订单提交成功！</p>
                                    </div>
                                </li>
                        ...
                        <li class="mui-table-view-cell">
                            <div class="mui-media-body  mui-pull-left">
                                ...
                                <span class="totalprice">￥<b><span id="sumorderstotal_TwoDecimal" style="font-size: 16px;">{$orderinfo.sumorderstotal}</span></b>
														</span><br>
                                <span class="mui-table-view-label">余额支付：</span>
                                <span class="totalprice">￥<b><span id="usemoney_TwoDecimal" style="font-size: 16px;">{$orderinfo.usemoney}</span></b>
														</span><br>
                                <span class="mui-table-view-label">实际支付：</span>
                                <span class="totalprice">￥<b><span id="paymentamount_TwoDecimal" style="font-size: 16px;">{$orderinfo.paymentamount}</span></b>
														</span><br>
                                {if $amount neq null}
                                <span class="mui-table-view-label" style="height: 20px; width: 72px;">商城卡支付：</span>
                                <span class="totalprice">￥<b><span id="amount_TwoDecimal" style="font-size: 16px;">{$amount}</span></b></span><br>
                                {/if}
                                <span class="mui-table-view-label">卡券优惠：</span>
                                <span class="totalprice">￥<b><span id="discount_TwoDecimal" style="font-size: 16px;">{$orderinfo.discount}</span></b>
														</span>
                        ...
                        {else}
                            ...
                            <li class="mui-table-view-cell">
                                <a href="orders_payment.php" class="mui-navigate-right orderlink">
                                    <div class="mui-media-body" style="text-align:center;">
                                        点击查看<b style="color:red">【全部已付款订单】</b>
                                    </div>
                                </a>
                            </li>
                            <li class="mui-table-view-cell">
...
<script type="text/javascript">
    ...
    mui.ready(function() {
        ...
        Zepto('#sumorderstotal_TwoDecimal').html(changeTwoDecimal_f(Zepto('#sumorderstotal_TwoDecimal').html()));
        Zepto('#usemoney_TwoDecimal').html(changeTwoDecimal_f(Zepto('#usemoney_TwoDecimal').html()));
        Zepto('#paymentamount_TwoDecimal').html(changeTwoDecimal_f(Zepto('#paymentamount_TwoDecimal').html()));
        Zepto('#amount_TwoDecimal').html(changeTwoDecimal_f(Zepto('#amount_TwoDecimal').html()));
        Zepto('#discount_TwoDecimal').html(changeTwoDecimal_f(Zepto('#discount_TwoDecimal').html()));
