...
<head>
    ...
    <style>
        ...
        .secKill_left{
            float:left;
            width:60%;
            background:linear-gradient(to right, #F32D8E, #F2306F);
            height:100%;"
        }
        .secKill_left span.final_price{
            font-size: 20px;
        }
        .secKill_left img{
...
<div class="container">
    ...
    <nav class="mui-bar mui-bar-tab bottom">
        <ul class="mui-table-view mui-grid-view mui-grid-9" style="height:100%">

            {*<form action="miao_submitorder.php" method="post">*}
            <input type="hidden" value="{$miaosha}" id="miaosha_statue">
            {*<input type="hidden" value="{$shoppingcart}" name ="shoppingcart" >*}
            {*<input type="hidden" value="{$miao_token}" name ="miao_token" >*}
            {*<input type="hidden" value="{$miao_id}" name ="miao_id" >*}
            {if $statue eq '1'}
                {if $rob_status eq '0'}
                    <li class="mui-table-view-cell mui-media mui-col-xs-3 pay" id="miaosha_buy_now"  >
                        <a href="javascript:void(0);"  id ="rob_click">立即抢购</a>
                    </li>
                {elseif $rob_status eq '1'}
                    <li class="mui-table-view-cell mui-media mui-col-xs-3 pay" id="miaosha_buy_now"  >
                        <a href="javascript:void(0);"  id="rob_pay">去支付>></a>
                    </li>
                {else}
                    <li class="mui-table-view-cell mui-media mui-col-xs-3 pay" id="miaosha_buy_now"  >
                        <a href="javascript:void(0);" style="color:white;background-color: grey;">已抢购</a>
                    </li>
                {/if}
            {elseif $statue eq '0'}
                <li class="mui-table-view-cell mui-media mui-col-xs-3 pay" id="miaosha_buy_now"  >
                    <a href="javascript:void(0);" style="color: #fff;background: #ffb03f;">等待中...</a>
                </li>
            {elseif $statue eq '-1'}
                <li class="mui-table-view-cell mui-media mui-col-xs-3 pay" id="miaosha_buy_now"  >
                    <a href="javascript:void(0);" style="color:white;background-color: grey">已结束</a>
                </li>
            {/if}
            {*</form>*}
        {*</ul>*}
            ...
            <div class="mui-content-padded goods-content"  id="propertygroup">
                ...
                <div id="goods" class="mui-control-content mui-active">
                    ...
                    <div class="mui-slider">
                        <div class="mui-slider-group">
                            <div class="mui-slider-item">
                                <img  id="productlogo" src="{$productinfo.productlogo}"/>
                                {*<p>{$miao_statue}++++</p>*}

                                <div class="secKill"  id = "miao_statue">
                                    <div class="secKill_left">
                                        <div><span class="final_price">
                                                {*<span style="text-decoration: line-through">*}
                                                    ...
                                                    {if $productinfo.activityname neq '' &&  $productinfo.zhekoulabel neq '' && $productinfo.zhekou neq ''}
                                                     ...
                                                     {elseif $miao_price neq ''}
                                                     <span id="shop_price"   >￥{$miao_price}</span>
                                                      {else}
                                        ...
                                        <img src="public/images/clock.png"/><span style="text-decoration: line-through">
                                            {if $productinfo.activityname neq '' &&  $productinfo.zhekoulabel neq '' && $productinfo.zhekou neq ''}
                                                <span id="shop_price"  style="color: #f23030;">￥{$productinfo.promotional_price}</span>
                                              {else}
                                                <span id="shop_price"  style="color: white;">￥{$productinfo.shop_price}</span>
                                            {/if}
                                        </span>
                                    </div>
                                    <div style="display: block;" id="activity_before" class="secKill_right">
                                        <div>距离开始还有:</div>
                                        <ul>
                                            <input type="hidden" value="{$starttime}" id = "starttime" >
                                            <input type="hidden" value="{$endtime}" id = "endtime" >
                                            <input type="hidden" value="{$token}" id = "token" >
                                            <input type="hidden" value="{$miao_id}" id = "miao_id" >
                                            <li><span class="time hour">00</span><span class="separator">:</span></li>
                                            <li><span class="time minute">00</span><span class="separator">:</span></li>
                                            <li><span class="time second">00</span><span class="separator">:</span></li>
                                        </ul>
                                    </div>
                                    <div style="display: none;"  id="activity_during" class="secKill_right">
                                        <div>距离结束还剩:</div>
                                        <ul>
                                            <li><span class="time hour">00</span><span class="separator">:</span></li>
                                            <li><span class="time minute">00</span><span class="separator">:</span></li>
                                    ...
                                    <div  style="display: none;" id="activity_after" class="secKill_right">
                                        <div style="position: relative;top: 30%;" id = "miaosha_statue">活动已经结束！</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mui-row goods-title">
                        ...
                        {*<button class="mui-col-xs-10" id = "check_purchase">测试</button>*}
                        <div class="clear"></div>
                        <div class="goods-price">
                            {*{if $productinfo.activityname neq '' &&  $productinfo.zhekoulabel neq '' && $productinfo.zhekou neq ''}*}
                                {*<span id="shop_price"  style="color: #f23030;">￥{$productinfo.promotional_price}</span>*}
                            {*{elseif $miao_price neq ''}*}
                                {*<span id="shop_price"  style="color: #f23030;">￥{$miao_price}</span>*}
                                {*{else}*}
                                {*<span id="shop_price"  style="color: #f23030;">￥{$productinfo.shop_price}</span>*}
                            {*{/if}*}
                    ...
                    <input type="hidden" value="{$productid}" id = "check_purchase">
                                ...
                                {*<ul style="margin:0px;padding-left: 18px;font-size: 11px;text-decoration: underline;">*}
                                    ...
                                    {*{if $activitynames neq '该商品没有参加其他活动'}*}
                                        {*{foreach name ="smk_detail" from = "$activitynames" item =activityname }*}
                                            {*<li class="salelist"><a href="{$sleslink}" style="color:#333">{$activityname} 618全场折扣</a></li>*}
                                        {*{/foreach}*}
                                    {*{/if}*}
                                {*</ul>*}
                            {*</div>*}
                    ...
                    {*</div>*}
                    <div class="mui-row wrap">
                        <div class="t-left mui-pull-left"  style="color: #8f8f94">剩余资格数：</div>
                        <div class="t-right mui-pull-left">
                                <p style="color: #000;">
                                    <span id="inventory_label">
                                        {$miao_number}
                                    </span>&nbsp;件
                                </p>
                        </div>
                    ...
                    <!-- 商品信息 -->
                    <div class="mui-row wrap">
                        <div class="t-left mui-pull-left" style="color: #8f8f94">仅限抢购一件商品</div>
                        <div class="t-right mui-pull-left">
                    ...
                    <div class="comment goods-comment">
                        <div class="comment-head clear">
                            <span class="mui-pull-left">评价内容</span>
                            <span id="more" class="mui-pull-right red">查看全部<span class="mui-icon mui-icon-arrowright"></span></span>
                        </div>
...
<script type="text/javascript">
    ...
    var salesactivityid = {$salesactivityid};
    var record ={$miao_id};
    {literal}
    var btn = document.getElementById("rob_click");
    if(btn!=undefined){
        btn.addEventListener("tap",function () {
            mui.ajax('/rob_confirmrob.php',{
                data:{
                ...
                success:function(data){
                    ...
                    eval("var arr="+data);
                    if( arr.status == 1){
                        mui.alert(arr.msg,"限时秒杀","去支付",function () {
                            location.href = "/miao_submitorder.php?productid="+productid+"&salesactivityid="+salesactivityid;
                        })
                    }else{
                        mui.alert(arr.msg,"限时秒杀","下次再来",function () {
    ...
    var rob_pay_btn = document.getElementById("rob_pay");
    if(rob_pay_btn!=undefined){
        rob_pay_btn.addEventListener("tap",function () {
            location.href = "miao_submitorder.php?productid="+productid+"&salesactivityid="+salesactivityid;
        });
    }
...
//  mui('body').on('tap', 'button#check_purchase', function (e) {
//      document.getElementById("check_purchase").disabled = true;
...
<script type="text/javascript" charset="utf-8">
    ...
    var miao_statue = {$miao_statue};

    {literal}

    //    console.log(miao_statue)
    ui1 =document.getElementById("miao_statue");
//    if (  miao_statue ==1){
//
//    }
    if(miao_statue !=1){
...
//        ui2 =document.getElementById("miao_statue");
...
//                console.log(333)
//                ui1 =document.getElementById("add_miaosha_cart");
//                ui2 =document.getElementById("miaosha_buy_now");
//                ui1.style.display="none";
//                ui2.style.display="none";
                clearInterval(timer);
                $("#activity_before").css("display","none");
                ...
                $("#miaosha_buy_now").css("display","none");
            }
