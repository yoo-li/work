...
sb.append('					        <img class="mui-media-object mui-pull-left" style="margin-top:18px;" src="'+v.headimgurl+'">');
...
sb.append('								<p class="mui-ellipsis">经手店员：<span class="price">'+v.assistant+'</span></p>');
sb.append('								<p class="mui-ellipsis">加入时间：<span class="price">'+v.published+'</span></p>');
sb.append('							</div> '); 
sb.append('				 </li> '); 
sb.append(' 	 	</ul>'); 
sb.append('</div>');  
...
sb.append('					      <p class="msgbody">您还没有邀请到一位顾客？<br>');  
sb.append('						  </p>  '); 
sb.append(' </div>'); 
return sb.toString(); 
		 }
