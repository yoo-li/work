		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
            ...
            <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
 					<a class="mui-control-item mui-active" href="physicalstore_billwaters.php">全部收益明细</a> 
					<a class="mui-control-item" href="physicalstore_accountbook.php">朋友圈推广收益明细</a>
 				</div> 
            </div>
		</header>
...
<script type="text/javascript">
	...
	function order_html(v)
	{
		...
		sb.append('								<p class="mui-ellipsis">订单总金额：<span class="price">¥' + v.sumorderstotal + '</span></p>');
 		sb.append('								<p class="mui-ellipsis" style="white-space:normal;">' + v.productname + '&nbsp;<span class="price">' + v.quantity + '</span>&nbsp;件,获得' + v.commissionsource + '佣金&nbsp;<span class="price">'+ v.amount +'</span>&nbsp;元【比率'+v.royaltyrate+'】【<span class="price">'+v.commissiontype+'</span>】</p>');
		sb.append('							</div> '); 
		sb.append('				 </li> '); 
		sb.append(' 	 	</ul>');
		sb.append('</div>');
	...
	function add_more()
	{
		...
		mui.ajax({
					 type: 'POST',
					 url: "physicalstore_billwaters.php",
