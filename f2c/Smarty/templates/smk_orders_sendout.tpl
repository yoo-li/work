...
<div class="mui-off-canvas-wrap mui-draggable">
	<div class="mui-inner-wrap">
		...
		<header class="mui-bar mui-bar-nav mui-row myorder_header">
			...
			<div class="mui-bar mui-title" style="margin-top: 40px;right: 0;left: 0;"  id="sortbar">
				<div id="segmentedControl" class="myorder_list_hd mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
					...
					<a href="smk_orders_sendout.php" class="mui-control-item mui-active">待发货</a>
...
<script type="text/javascript">
	...
	function order_html(v)
	{
		...
		sb.append('	<button type="button" class="mui-btn">请等待商家发货</button>');
		if(v.smkaddressid){
			sb.append('	<a href="QRCode.php?record=' + v.orderid + '" ><button type="button" class="mui-btn">二维码</button></a>');
		}
		sb.append('</div>');
		sb.append('	</li>');
		return sb.toString();
