			...
			<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">  
                 ...
                 <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
		 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
		 					...
		 					<a class="mui-control-item" href="profit_commission.php">提成收益</a> 
							<a class="mui-control-item mui-active" href="profit_popularize.php">推广收益</a>
		 				</div> 
                 </div>
			</header> 
...
sb.append('					<span style="width:120px;text-align:left;display:inline-block;">'+v.published+'</span>'+v.inviteprofilename+'');  
sb.append('				</div>');  
sb.append('				<div class="mui-media-body mui-pull-right">');  
sb.append('					<span class="price">¥'+v.amount+'</span>');  
sb.append('				</div> ');  
sb.append('           </li>');   
				 return sb.toString(); 
		 }
 ...
 sb.append('				<div class="mui-media-body  mui-pull-left">');  
 sb.append('					<span style="width:120px;text-align:left;display:inline-block;">推广日期</span>推广人');  
 sb.append('				</div>');  
 sb.append('				<div class="mui-media-body mui-pull-right">');  
 sb.append('				收益');  
 sb.append('				</div> ');  
	    ...
	    function add_more() {
			var page = Zepto('#page').val();
	            ...
	            mui.ajax({
	                type: 'POST',
	                url: "profit.ajax.php",
	                data: 'type=popularize&page=' + page,
