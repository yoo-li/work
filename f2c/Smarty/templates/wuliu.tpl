...
<head>
	...
	<style>
        ...
        .smart-result-kuaidinum{
        	background: #fb3e21 none repeat scroll 0 0;
        }
		{/literal}
	</style>
...
<div class="mui-off-canvas-wrap mui-draggable" id="offCanvasWrapper">
	<div class="mui-inner-wrap">
		...
		<nav class="mui-bar mui-bar-tab" style="height:35px;line-height:35px;top: 44px;">
			<div>
				<span id="result-comname" class="smart-result-comname" style="width:35%">{$type}</span>
				<span id="result-kuaidinum" class="smart-result-kuaidinum" style="width:63%">{$invoicenumber}</span>
			</div>
		</nav>
		{include file='footer.tpl'}
		<div id="pullrefresh" class="mui-content mui-scroll-wrapper" style="top: 37px;">
...
<script type="text/javascript">
	{if $logisticroutes|@count eq 0 && $jd eq 0}
	mui.ajax({ldelim}
				 type: 'GET',
