                            ...
                            <div class="mui-slider-item">
                                ...
                                <div class="secKill"  id = "miao_statue">
                                    <div class="secKill_left">
                                        <div><span>￥</span><span class="final_price">100.00</span></div>
                                        <img src="public/images/clock.png"/><span>￥148.00</span>
                                    </div>
                                    <div style="display: block;" id="activity_before" class="secKill_right">
                                        <div>距离开始还有:</div>
                                        <ul>
                                            <input type="hidden" value="{$starttime}" id = "starttime" >{$starttime}</input>
                                            <input type="hidden" value="{$endtime}" id = "endtime" >{$endtime}</input>
                            ...
                            <div class="mui-pull-left">
                                <ul style="margin:0px;padding-left: 18px;font-size: 11px;text-decoration: underline;">
                                    <!--循环加载出li内的“href”和“打折活动名称”-zl-->
                                          {foreach name ="smk_detail" from = "$activity_info" item =activity }
                                            <li class="salelist"><a href="{$activity.url}" style="color:#333">{$activity.activityname} </a></li>
                                            {*<li class="salelist"><a href="www" style="color:#333">{$activity.url} 618全场折扣</a></li>*}
                                        {/foreach}
                                 </ul>
                            </div>
                        {/if}
...
//            var starttime= starttime;  /*定义开始时间*/
            var endtime=new Date(endtime1);  /*定义结束时间*/ //            var endtime= endtime;  /*定义结束时间*/
//            console.log(starttime)
//            console.log(endtime)
