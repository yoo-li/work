...
sb.append('					        <img class="mui-media-object mui-pull-left" style="margin-top:10px;" src="'+v.headimgurl+'">');
...
sb.append('					      <p class="msgbody">您还没有邀请到一位店员？<br>');  
sb.append('						  </p>  '); 
sb.append(' </div>'); 
return sb.toString(); 
		 }
	    ...
	    function add_more() {
			var page = Zepto('#page').val();
	            ...
	            mui.ajax({
	                type: 'POST',
	                url: "physicalstore_assistant.php",
