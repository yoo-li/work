...
try {
   ...
   // $wxsmk_cardno = '507110000404569'; //卡号
...
//    var_dump($amount);die;
   // $amount = '10000';
    ...
    //     die();
    // }
    $users_cardno = XN_Query::create('Content')->tag('Mall_SmkCardRecords')
        ->filter('type', 'eic', 'Mall_SmkCardRecords')
        ->filter('my.card', '=', $wxsmk_cardno)
        ->execute();
    if($users_cardno){
        echo '202';
        die();
