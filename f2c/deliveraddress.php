<?php
	...
	if (isset($_REQUEST['result']) && $_REQUEST['result'] != '')
	{
		...
		try
		{
			...
			if (isset($weixin_deliveraddress['err_msg']) && $weixin_deliveraddress['err_msg'] == "edit_address:ok")
			{
				$province  = $weixin_deliveraddress['proviceFirstStageName'];
				$city      = $weixin_deliveraddress['addressCitySecondStageName'];
				$district  = $weixin_deliveraddress['addressCountiesThirdStageName'];
				$address   = $weixin_deliveraddress['addressDetailInfo'];
				$mobile    = $weixin_deliveraddress['telNumber'];
				$consignee = $weixin_deliveraddress['userName'];
				$zipcode   = $weixin_deliveraddress['addressPostalCode'];
