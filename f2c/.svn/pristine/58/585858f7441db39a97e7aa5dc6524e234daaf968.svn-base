        ...
        <div class="mui-inner-wrap">
            ...
            <header class="mui-bar mui-bar-nav">
                  ...
                  <div class="mui-title tit-searchbar">
                      <ul class="mui-table-view mui-searchbar" style="line-height: 27px;">
...
{literal}
	...
	function product_html(v) {
			 ...
			 sb.append('         	<a href="detail.php?from=index&productid='+v.productid+'">');
 			 sb.append('            <img id="product_item_'+v.productid+'" class="mui-media-object  img-responsive" src="'+v.productlogo+'" data-original="'+v.productlogo+'">');
