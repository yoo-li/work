   ...
   protected function doRequest($method, $url, &$body = null,$contentType=null, $additionalHeaders = null) {
	   ...
	   * responses with no body (NING-7074) */
        ...
        if ($res === false) {
			...
			$this->errorprint('警告','服务器连接失败!<br><br><div style="text-align: left;padding-left: 30px;"> 湖南赛明威科技有限公司<br>Copyright © 2010-2014 saasw.com <br>紧急联系手机：15974160308(王真明)<br></div>');	
