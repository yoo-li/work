...
<head>
    ...
    <title>{if $supplier_info.mainpagetitle neq '0'}{$supplier_info.suppliername}{/if} </title>
    ...
    <div class="mui-off-canvas-wrap mui-draggable" id="offCanvasWrapper">
        ...
        <div class="mui-inner-wrap">
			...
			{include file='footer.tpl'}
             <div id="pullrefresh" class="mui-content mui-scroll-wrapper"  {if $supplier_info.mainpagetitle eq '0'}style="padding-top: 45px;"{/if}>
                 <div class="mui-scroll">
						 ...
						 {if $supplier_info.mainpagetitle eq '0'}
			                  ...
			                  {if $supplier_info.suppliertype eq 'F2C'}
		                      <!--icon menu-->
