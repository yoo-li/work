			...
			<div class="mui-scroll-wrapper">
				<div class="mui-scroll">
					...
					<div class="banner-title clear" style="margin-top: 10px;">
						...
						<!-- <a class="mui-pull-right text-right" href="smk_mycard.php" style="color:#fb3e21;">新卡绑定<span  style="color:#fb0000;" class="mui-icon mui-icon-forward"></span> </a> -->
					</div>
					<ul class="mui-table-view mui-grid-view mui-grid-9 card">
						<li class="mui-table-view-cell mui-media mui-col-xs-3">
							<a href="smk_mycard.php">
								<span>￥{$totle_account}</span>
								<p>商城卡</p>
							</a>
						</li>
						<li class="mui-table-view-cell mui-media mui-col-xs-3">
