		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
			...
			<div class="mui-title mui-content tit-sortbar" id="sortbar">
				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
					...
					<a class="mui-control-item mui-active" href="orders_receipt.php">待收货</a>
...
<script type="text/javascript">
	...
	function order_html(v)
	{
		...
		{
			sb.append('						 <a class="mui-icon iconfont icon-queren01 confirmreceipt button-color"  data-id="' + v.orderid + '" href="javascript:;">&nbsp;确认收货</a> ');
		}
		else
		{
			sb.append('						 <a class="mui-icon iconfont icon-qianggou" href="javascript:;" style="color:#cc3300">&nbsp;请等待商家发货</a> ');
		}
