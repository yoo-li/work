...
//    ->filter('my.profileid', '=', 'lpkvzfvdhz8')
...
$supplierid = $_SESSION['supplierid'];
    ...
    $_SESSION['profileid'] = 'a7xc6bydiyf';//lpkvzfvdhz8 ||  a7xc6bydiyf
    $_SESSION['supplierid'] = 6804;
    $profileid = $_SESSION['profileid'];
    $supplierid = $_SESSION['supplierid'];
}

////var_dump($supplier_profile[0]);
//var_dump($_SESSION);
//die;
//var_dump($_REQUEST);
//die;
...
if (isset($_REQUEST['appid']) && $_REQUEST['appid'] != '' &&
    isset($_REQUEST['type']) && ($_REQUEST['type'] == 'init' || $_REQUEST['type'] == 'usercenter' || $_REQUEST['type'] == 'uri')
)
{
...
//var_dump($profile_info);echo 2;die;
...
//var_dump($supplier_info['hassourcer']);die;
