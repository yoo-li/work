...
//$secret_key = 'yPkNEgdF78cwk11P2NCeA4oDaPKTR2eG';//此处替换为应用的secret key
//$api_Key = 'qmOOsCCYPDl1DGzXGfgmn2Zy'; 
...
// echo "================>>>ok";
// test_pushMessage_android('833964412862566783');
echo "================>>>ok-ios--";
test_pushMessage_ios($_GET["u"]);
