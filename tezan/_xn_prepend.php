...
//  $_SERVER["HTTP_X_NING_LOCAL_API_HOST_PORT"]="121.43.174.246:8000"; //惠民商城
    $_SERVER["HTTP_X_NING_LOCAL_API_HOST_PORT"]="121.196.203.96:8000"; //事务官 站点
//	$_SERVER["HTTP_X_NING_LOCAL_API_HOST_PORT"]="116.62.5.130:8000"; //天天站
//	$_SERVER["HTTP_X_NING_LOCAL_API_HOST_PORT"]="172.16.0.131:8000"; //飞哥


    require XN_INCLUDE_PREFIX . '/XN/Cache.php';
	require XN_INCLUDE_PREFIX . '/XN/MemCache.php';
	require XN_INCLUDE_PREFIX . '/XN/Rob.php';
	require XN_INCLUDE_PREFIX . '/XN/Debug.php';
