<?php /* Smarty version 2.6.18, created on 2017-08-04 08:48:25
         compiled from WzRegister.tpl */ ?>
...
<head>
    ...
    <?php if ($this->_tpl_vars['MODE'] == 'thrid'): ?>
        ...
        <script type="text/javascript">
            var currentModule="<?php echo $this->_tpl_vars['table']; ?>
";
            <?php echo '
            $(function() {
    ...
    <?php endif; ?>
    <script type="text/javascript">
        <?php if ($this->_tpl_vars['MODE'] == 'second'): ?>
        <?php echo '
                    ...
                    <div class="verify_step">
                        <div class="inner">
                            <ol class="steps"> <!-- span元素添加此样式 class="done"-->
                                <li class="first"><span <?php if ($this->_tpl_vars['MODE'] == 'first'): ?>class="done"<?php endif; ?>><em>1、填写账户信息</em><i></i></span></li>
                                <li class="second"><span <?php if ($this->_tpl_vars['MODE'] == 'second'): ?>class="done"<?php endif; ?>><em>2、填写公司信息</em><i></i></span></li>
                                <li class="thrid"><span <?php if ($this->_tpl_vars['MODE'] == 'thrid'): ?>class="done"<?php endif; ?>><em>3、上传验证资料</em><i></i></span></li>
                                <li class="fourth"><span <?php if ($this->_tpl_vars['MODE'] == 'success'): ?>class="done"<?php endif; ?>><em>4、注册成功</em><i></i></span></li>
                                <li class="last"><span <?php if ($this->_tpl_vars['MODE'] == 'success'): ?>class="done"<?php endif; ?>><em></em><i></i></span></li>
                            </ol>
                        </div>
                    </div>
                    <?php if ($this->_tpl_vars['MODE'] == 'first'): ?>
...
">
                            <input type="hidden" name="guid" id="guid" value="<?php echo $this->_tpl_vars['GUID']; ?>
">
                            ...
                            <div class="security_code">
                                <ul>
                                    <li class="ui-form-item">
                                        ...
                                        <input class="ui-input" type="text" id="r_provider" maxlength="30" tabindex="1" name="r_provider" placeholder="请输入商家全称" value="<?php echo $this->_tpl_vars['PROVIDER']; ?>
" data-rule="required;">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_username" class="ui-label">用户名：</label>
                                        <input class="ui-input" type="text" tabindex="2" id="r_username"  name="r_username" placeholder="2-20个字符，登录名，注册成功后不可修改" value="<?php echo $this->_tpl_vars['USERNAME']; ?>
" data-rule="required;length[2~20];remote[/passport/checkSupplier.php]">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_password" class="ui-label">密码：</label>
                                        <input class="ui-input" id="r_password" tabindex="3" name="r_password" type="password" placeholder="5~18个字符，可使用字母、数字" value="<?php echo $this->_tpl_vars['PASSWORD']; ?>
" data-rule="required;password">
                                    </li>

                                    <li class="ui-form-item">
                                        <label for="r_repassword" class="ui-label">确认密码：</label>
                                        <input class="ui-input" id="r_repassword" tabindex="4" name="r_repassword" type="password" placeholder="5~18个字符，可使用字母、数字" value="<?php echo $this->_tpl_vars['PASSWORD']; ?>
" data-rule="required;match(password);length[5~18]">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_contact" class="ui-label">联系人：</label>
                                        <input class="ui-input" type="text" id="r_contact" tabindex="5" name="r_contact" maxlength="30" placeholder="请输入联系人姓名" value="<?php echo $this->_tpl_vars['CONTACT']; ?>
" data-rule="required;length[0~30]">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_phone" class="ui-label">手机号：</label>
                                        <input class="ui-input" type="text" id="r_phone" tabindex="6" name="r_phone" placeholder="请输入联系人手机号码" value="<?php echo $this->_tpl_vars['PHONE']; ?>
" data-rule="required;mobile;remote[/passport/checkSupplierphone.php]">
                                    </li>
                                    <li class="ui-form-item">
                                        <label class="ui-label" for="r_email">邮箱：</label>
                                        <input class="ui-input"  type="text" id="r_email" tabindex="7" name="r_email" placeholder="请输入您常用的电子邮箱" value="<?php echo $this->_tpl_vars['EMAIL']; ?>
" data-rule="email;">
                                    </li>
                                    <li class="ui-form-item">
...
">
                            <input type="hidden" name="r_username" value="<?php echo $this->_tpl_vars['USERNAME']; ?>
">
                            <input type="hidden" name="r_invitecode" value="<?php echo $this->_tpl_vars['INVITECODE']; ?>
">
                            <input type="hidden" name="r_email" value="<?php echo $this->_tpl_vars['EMAIL']; ?>
">
                            <input type="hidden" name="r_contact" value="<?php echo $this->_tpl_vars['CONTACT']; ?>
">
                            <input type="hidden" name="r_phone" value="<?php echo $this->_tpl_vars['PHONE']; ?>
">
                            <input type="hidden" name="r_provider" value="<?php echo $this->_tpl_vars['PROVIDER']; ?>
">
                            <input type="hidden" name="r_password" value="<?php echo $this->_tpl_vars['PASSWORD']; ?>
">
                            <input type="hidden" name="record" value="<?php echo $this->_tpl_vars['record']; ?>
">
                            <div class="security_code">
                                <ul>
                                    <li class="ui-form-item">
                                        ...
                                        <input class="ui-input" type="text" id="r_shortname" maxlength="30" tabindex="1" name="r_shortname" placeholder="请输入商家简称" value="<?php echo $this->_tpl_vars['SHORTNAME']; ?>
" data-rule="required;">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_bankname" class="ui-label">开户银行：</label>
                                        <input class="ui-input" tabindex="12" type="text" id="r_bankname" tabindex="3" name="r_bankname" placeholder=" 请输入公司开户银行(具体到分行)" value="<?php echo $this->_tpl_vars['BANKNAME']; ?>
" data-rule="required;">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_bankowner" class="ui-label">开户名：</label>
                                        <input class="ui-input" type="text" id="r_bankowner" tabindex="4" name="r_bankowner" placeholder="请输入公司银行账户开户名" value="<?php echo $this->_tpl_vars['BANKOWNER']; ?>
" data-rule="required;remote[/passport/checkBankowner.php]">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_bankaccount" class="ui-label">银行账号：</label>
                                        <input class="ui-input" type="text" id="r_bankaccount" tabindex="5" name="r_bankaccount" placeholder="请输入公司银行账号" value="<?php echo $this->_tpl_vars['BANKACCOUNT']; ?>
" data-rule="required;">
                                    </li>
                                    <li class="ui-form-item">
                                        <label for="r_ceo" class="ui-label" id="r_ceo_label">法人代表：</label>
                                        <input class="ui-input" type="text" id="r_ceo" tabindex="6" name="r_ceo" placeholder="请输入法人代表姓名" value="<?php echo $this->_tpl_vars['CEO']; ?>
" data-rule="required;">
                                    </li>
                                    <li class="ui-form-item">
                                    ...
                                    <li class="ui-form-item">
                                        ...
                                        <input class="ui-input" type="text" style="float:left;" id="r_companyaddress" tabindex="10" name="r_companyaddress" placeholder="请输入公司详细地址" value="<?php echo $this->_tpl_vars['COMPANYADDRESS']; ?>
" data-rule="required;" data-target="searchaddress">
...
">
                            <input type="hidden" name="r_phone" value="<?php echo $this->_tpl_vars['PHONE']; ?>
">
                            <input type="hidden" name="r_channel" value="<?php echo $this->_tpl_vars['CHANNEL']; ?>
">
                            <input type="hidden" name="r_companyaddress" value="<?php echo $this->_tpl_vars['COMPANYADDRESS']; ?>
">
                            <input type="hidden" name="r_provider" value="<?php echo $this->_tpl_vars['PROVIDER']; ?>
">
                            <input type="hidden" name="r_shortname" value="<?php echo $this->_tpl_vars['SHORTNAME']; ?>
">
                            <input type="hidden" name="r_password" value="<?php echo $this->_tpl_vars['PASSWORD']; ?>
">
                            <input type="hidden" name="latitude" value="<?php echo $this->_tpl_vars['LATITUDE']; ?>
">
                            <input type="hidden" name="longitude" value="<?php echo $this->_tpl_vars['LONGITUDE']; ?>
">
                            <input type="hidden" name="r_province" value="<?php echo $this->_tpl_vars['province']; ?>
">
                            <input type="hidden" name="r_city" value="<?php echo $this->_tpl_vars['city']; ?>
">
                            <input type="hidden" name="r_ceo" value="<?php echo $this->_tpl_vars['CEO']; ?>
">
                            <input type="hidden" name="r_bankowner" value="<?php echo $this->_tpl_vars['BANKOWNER']; ?>
">
                            <input type="hidden" name="r_bankaccount" value="<?php echo $this->_tpl_vars['BANKACCOUNT']; ?>
">
                            <input type="hidden" name="r_bankname" value="<?php echo $this->_tpl_vars['BANKNAME']; ?>
">
                            <input type="hidden" name="r_returngoods_address" value="<?php echo $this->_tpl_vars['returngoods_address']; ?>
">
...
">
                    ...
                    <?php endif; ?>
                    <?php if ($this->_tpl_vars['MODE'] == 'success'): ?>
        ...
        <div class="footer" style="text-align: center;bottom:20px;">
            <div id="copyright">Copyright © 2010-2015 <?php echo $this->_tpl_vars['copyrights']['site']; ?>
 All Rights Reserved. <?php echo $this->_tpl_vars['copyrights']['icp']; ?>
</div>
        </div>
    </div>
</body>
