<?php /* Smarty version 2.6.18, created on 2017-07-31 11:05:51
         compiled from uitype/19.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strpos', 'uitype/19.tpl', 7, false),)), $this); ?>
...
<?php else: ?>
	<?php if ($this->_tpl_vars['edit_width'] != '' && $this->_tpl_vars['edit_width'] != '0'): ?>
		...
		<?php endif; ?>
	<?php else: ?>
		<?php $this->assign('editwidth', "width:80%;"); ?>
	<?php endif; ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['field_unit'] != ''): ?>
	<span class="form-control" style="position:absolute;bottom:0px;padding:0px 2px;margin-left:-1px;z-index:-1;"><?php echo $this->_tpl_vars['field_unit']; ?>
</span>
<?php endif; ?>
<?php if ($this->_tpl_vars['remotevalidationfunc'] != ''): ?>
