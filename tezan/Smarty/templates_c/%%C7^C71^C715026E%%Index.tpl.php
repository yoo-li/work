<?php /* Smarty version 2.6.18, created on 2017-08-27 13:24:05
...
<head>
	...
	<title><?php echo $this->_tpl_vars['APPLICATIONNAME']; ?>
</title>
	<?php if ($this->_tpl_vars['copyrights']['favicon'] == ''): ?>
		<link rel="shortcut icon" href="favicon.ico" type="image/x-icon"/>
	<?php else: ?>
		<link rel="shortcut icon" href="<?php echo $this->_tpl_vars['copyrights']['favicon']; ?>
" type="image/x-icon"/>
	<?php endif; ?>
	<!-- bootstrap - css -->
...
<div id="bjui-window">
	<header id="bjui-header" style="height:50px;">
		<div class="bjui-navbar-header">
			...
			<a class="bjui-navbar-logo" href="#"><img src="<?php echo $this->_tpl_vars['copyrights']['logo']; ?>
"></a>
		</div>
		<nav id="bjui-navbar-collapse" style="margin-top: 0px;">
			<ul id="navbartopline" class="bjui-navbar-right">
				...
				<?php if ($this->_tpl_vars['shoppingcart_num'] !== false): ?>
					<li>
						<a data-toggle="dialog" data-id="shoppingcartsdialog" data-title="购物车" data-mask="true" data-maxable="false" data-resizable="false" data-width="800" data-height="600" href="index.php?module=Ma_Products&action=ShoppingCart"><?php echo $this->_tpl_vars['APP']['LBL_SHOPPINGCARTS']; ?>

							<span id="shoppingcart_num" class="badge"><?php echo $this->_tpl_vars['shoppingcart_num']; ?>
</span></a></li>
				<?php endif; ?>
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $this->_tpl_vars['APP']['LBL_MYACCOUNT']; ?>

						<span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li>
							<a href="index.php?module=Users&action=ChangePassword&profileid=<?php echo $this->_tpl_vars['VIEWER']; ?>
" data-toggle="dialog" data-id="changepwd_page" data-mask="true" data-maxable="false" data-resizable="false" data-width="500" data-height="360">&nbsp;<span class="glyphicon glyphicon-lock"></span> <?php echo $this->_tpl_vars['APP']['LBL_CHANGEPASSWORD']; ?>

																																																													 &nbsp;</a>
						</li>
						<!--<li><a href="#">&nbsp;<span class="glyphicon glyphicon-user"></span> <?php echo $this->_tpl_vars['APP']['LBL_MYPERSONINFO']; ?>
</a></li>
                        <li class="divider"></li>
                        -->
						<li>
							<a href="index.php?module=Users&action=about_us" data-toggle="dialog" data-id="changepwd_page" data-mask="true" data-maxable="false" data-resizable="false" data-width="500" data-height="360">&nbsp;<span class="glyphicon glyphicon-copyright-mark"></span> <?php echo $this->_tpl_vars['APP']['LBL_ABOUTUS']; ?>

																																																						   &nbsp;</a>
						</li>
						<li class="divider"></li>
						<li>
							<a href="index.php?module=Users&action=Logout" class="red">&nbsp;<span class="glyphicon glyphicon-off"></span> <?php echo $this->_tpl_vars['APP']['LBL_LOGOUT']; ?>

							</a></li>
					</ul>
				</li>
				<?php if ($this->_tpl_vars['copyrights']['program'] == 'ma'): ?>
					<li><a target="_blank" href="/help/"><i class="fa fa-question-circle"></i> <?php echo $this->_tpl_vars['APP']['LBL_HELP']; ?>
</a></li>
				<?php endif; ?>
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu" id="bjui-themes">
						<li>
							<a href="javascript:;" class="theme_default" data-toggle="theme" data-theme="default">&nbsp;<i class="fa fa-flag"></i> <?php echo $this->_tpl_vars['APP']['LBL_THEME_DEFAULT']; ?>

																												  &nbsp;&nbsp;</a></li>
						<li>
							<a href="javascript:;" class="theme_orange" data-toggle="theme" data-theme="orange">&nbsp;<i class="fa fa-flag"></i> <?php echo $this->_tpl_vars['APP']['LBL_THEME_ORANGE']; ?>

							</a></li>
						<li>
							<a href="javascript:;" class="theme_purple" data-toggle="theme" data-theme="purple">&nbsp;<i class="fa fa-flag"></i> <?php echo $this->_tpl_vars['APP']['LBL_THEME_PURPLE']; ?>

							</a></li>
						<li class="active">
							<a href="javascript:;" class="theme_blue" data-toggle="theme" data-theme="blue">&nbsp;<i class="fa fa-flag"></i> <?php echo $this->_tpl_vars['APP']['LBL_THEME_BLUE']; ?>

							</a></li>
						<li>
							<a href="javascript:;" class="theme_green" data-toggle="theme" data-theme="green">&nbsp;<i class="fa fa-flag"></i> <?php echo $this->_tpl_vars['APP']['LBL_THEME_GREEN']; ?>
			...
			<ul id="bjui-navbar-right" style="padding-right:40px;padding-top:30px;">
				<li style="float: right;"><?php echo $this->_tpl_vars['CURRENT_USER']; ?>
，<?php echo $this->_tpl_vars['APP']['LBL_HELLO']; ?>

														 &nbsp;<?php if ($this->_tpl_vars['LASTLOGINTIME'] != ''): ?><?php echo $this->_tpl_vars['APP']['LBL_LASTLOGINTIME']; ?>
：<?php echo $this->_tpl_vars['LASTLOGINTIME']; ?>
<?php else: ?><?php echo $this->_tpl_vars['APP']['LBL_FIRSTLOGINTIME']; ?>
<?php endif; ?>
														 &nbsp;&nbsp;<?php if ($this->_tpl_vars['TRIALTIME'] != ''): ?><?php echo $this->_tpl_vars['APP']['LBL_TRIALTIME']; ?>
: <?php echo $this->_tpl_vars['TRIALTIME']; ?>
<?php endif; ?></li>
			</ul>
		</nav>
	</header>
	...
	<div id="bjui-container">
		<div id="bjui-leftside">
			...
			<div id="bjui-sidebar">
				<div class="toggleCollapse"><h2><i class="fa fa-bars"></i> <?php echo $this->_tpl_vars['APP']['LBL_MAINMENU']; ?>
 <i class="fa fa-bars"></i></h2>
				...
				<div class="navtabPage unitBox">
					<div class="bjui-pageContent" style="background:#FFF;padding:0px;">
						<div style="margin:1px;">
							<?php $this->assign('rowindex', 1); ?>
							<?php $this->assign('homeframescolumn', $this->_tpl_vars['copyrights']['homeframescolumn']); ?>
...
if ($this->_foreach['homeframe']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['stuffkey'] => $this->_tpl_vars['homeinfo']):
        $this->_foreach['homeframe']['iteration']++;
?>
							<?php if ($this->_tpl_vars['homeinfo']['width'] == '100%'): ?>
							<?php if ($this->_tpl_vars['rowindex'] == '1'): ?>
							<div style="overflow:hidden;width:100%;">
								<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "MainHomeBlock.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
							</div>
...
unset($_smarty_tpl_vars);
 ?>
						...
						<?php endif; ?>
						<?php else: ?>
						<?php $this->assign('layoutpos', $this->_tpl_vars['rowindex']%$this->_tpl_vars['homeframescolumn']); ?>
						<?php if (($this->_foreach['homeframe']['iteration'] <= 1) || $this->_tpl_vars['layoutpos'] == 1): ?>
						<div style="overflow:hidden;width:100%;">
							<?php endif; ?>
							<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "MainHomeBlock.tpl", 'smarty_include_vars' => array()));
...
unset($_smarty_tpl_vars);
 ?>
							<?php if (($this->_foreach['homeframe']['iteration'] == $this->_foreach['homeframe']['total']) || $this->_tpl_vars['layoutpos'] == 0): ?>
						</div>
						<?php endif; ?>
...
" target="_blank"><?php echo $this->_tpl_vars['copyrights']['site']; ?>
	...
	&nbsp;&nbsp;&nbsp;<span><?php echo $this->_tpl_vars['copyrights']['icp']; ?>
</span>
	&nbsp;&nbsp;&nbsp;<span><?php echo $this->_tpl_vars['APP']['LBL_RECOMMENDEXPLORER']; ?>
</span>
</footer>
</div>
...
<script type="text/javascript">
	...
	var serial_port      = "<?php echo $this->_tpl_vars['SAVESCANPORT']; ?>
";
	var serialPort       = null;
	var scancodecallback = {};
	var isComplete       = true;
	...
	function init_scanport()
	{
		try
		{
			...
			var scancodehtml = '<li><div id="scanmessageinfo"></div></li>' +
							   ...
							   '<li id="1" class="<?php if ($this->_tpl_vars['SAVESCANPORT'] == 'COM1'): ?>active<?php endif; ?>"><a href="javascript:;" onclick="setscanport(this,\'COM1\');">&nbsp; COM1 </a></li>' +
							   '<li id="2" class="<?php if ($this->_tpl_vars['SAVESCANPORT'] == 'COM2'): ?>active<?php endif; ?>"><a href="javascript:;" onclick="setscanport(this,\'COM2\');">&nbsp; COM2 </a></li>' +
							   '<li id="3" class="<?php if ($this->_tpl_vars['SAVESCANPORT'] == 'COM3'): ?>active<?php endif; ?>"><a href="javascript:;" onclick="setscanport(this,\'COM3\');">&nbsp; COM3 </a></li>' +
							   '<li id="4" class="<?php if ($this->_tpl_vars['SAVESCANPORT'] == 'COM4'): ?>active<?php endif; ?>"><a href="javascript:;" onclick="setscanport(this,\'COM4\');">&nbsp; COM4 </a></li>' +
							   '<li id="5" class="<?php if ($this->_tpl_vars['SAVESCANPORT'] == 'COM5'): ?>active<?php endif; ?>"><a href="javascript:;" onclick="setscanport(this,\'COM5\');">&nbsp; COM5 </a></li>' +
							   '<li id="6" class="<?php if ($this->_tpl_vars['SAVESCANPORT'] == 'COM6'): ?>active<?php endif; ?>"><a href="javascript:;" onclick="setscanport(this,\'COM6\');">&nbsp; COM6 </a></li>' +
							   '</ul>' +
							   '</li>';
...
<script type="text/javascript">
	var selectprinter = "<?php echo $this->_tpl_vars['SELECTPRINTER']; ?>
";
	<?php echo '
...
<script type="text/javascript">
	...
	/*
	<?php if ($this->_tpl_vars['APPROVALDIALOG'] == 'true'): ?>
	 function approve_dialog()
	 {
	 $(this).dialog({id:'ApproveDialog', url:'index.php?module=Approvals&action=ApproveDialog', title:'快捷审批',width:700,height:500,mask:true,resizable:false,drawable:false,maxable:false});
	}
	 setTimeout("approve_dialog();",1000);
	<?php endif; ?>
	 */
	<?php if ($this->_tpl_vars['SUPPLIERWARN'] == 'true'): ?>
	function warn_dialog()
	{
		...
		$.post(url, "", function (data)
		{
			if (data != "")
			{
				$(this).alertmsg('warn', data, {displayMode: 'slide',
		...
		//$(this).dialog({id:'WarnDialog', url:url, title:'资质预警',width:700,height:500,mask:true,resizable:false,drawable:false,maxable:false});
