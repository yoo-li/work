<?php /* Smarty version 2.6.18, created on 2017-08-21 16:48:40
         compiled from uitype/98.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strpos', 'uitype/98.tpl', 16, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['READONLY'] != 'true' && $this->_tpl_vars['read_only'] != '1'): ?>padding-right: 25px;<?php endif; ?><?php if ($this->_tpl_vars['READONLY'] != 'true' && $this->_tpl_vars['read_only'] != '1'): ?>cursor: pointer;<?php endif; ?>"
	...
	<?php if ($this->_tpl_vars['READONLY'] != 'true' && $this->_tpl_vars['read_only'] != '1'): ?>
		<a class="bjui-lookup" data-toggle="lookupbtn" data-newurl=""
			data-oldurl="index.php?module=Public&action=SelectRole&mode=<?php echo $this->_tpl_vars['treetype']; ?>
&roleid=" 
			data-url="index.php?module=Public&action=SelectRole&mode=<?php echo $this->_tpl_vars['treetype']; ?>
&roleid=<?php echo $this->_tpl_vars['fldvalue']; ?>
" 
			data-group="<?php echo $this->_tpl_vars['fldname']; ?>
" data-maxable="false" data-title="请选择部门"  data-width="300" data-height="300" href="javascript:;" 
			data-callback="<?php echo $this->_tpl_vars['fldname']; ?>
_callback" 
