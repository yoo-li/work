<?php /* Smarty version 2.6.18, created on 2017-07-20 08:54:46
         compiled from finance.tpl */ ?>
...
<div class="bjui-pageContent">
    ...
    <form action="index.php?module=Mall_Finance&action=vendor_getexcel" method="post">
        <div style="padding: 2px 0px;">
            <span style="display:inline-block;width:150px;">订单结算明细表</span>
            <input class="btn btn-default" data-icon="file-excel-o" type="submit" name="" value="导出EXCEL" onclick="return  btn1( )">   </input>&nbsp;&nbsp;
            <a  href="index.php?module=Mall_Finance&action=vendor_getexcel" target="_blank" class="btn btn-default" onclick=" return btn2(this )">打印</a><br>
            <input type="hidden" name="starttime" value="" class="start1" >  </input>
            <input type="hidden" name="endtime" value="" class="end1">  </input>
        </div>
    </form>
