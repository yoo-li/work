...
<script type="text/javascript" charset="utf-8">
	...
	{ldelim}
		$(this).dialog({ldelim}id:'print', url:'index.php?module={$MODULE}&action=TemplatePrintbyout&oper=view&record={$RECORD}&invoiceprintid='+templateid, title:'打印',width:900,height:600,mask:true,resizable:false,maxable:false{rdelim});
		var printwondiw=window.open('index.php?module={$MODULE}&action=TemplatePrintbyout&oper=view&record={$RECORD}&invoiceprintid='+templateid,'打印','width=900,height=600');
		printwondiw.print();
		//printwondiw.close();
	{rdelim}
	...
	{ldelim}
		window.location="/index.php?module={$MODULE}&action=TemplatePrintbyout&oper="+mode+"&record={$RECORD}&invoiceprintid={$INVOICEPRINTID}";
	{rdelim}

	function print_out()
	{ldelim}
		window.open("/index.php?module={$MODULE}&action=TemplatePrintbyout&oper=print&record={$RECORD}&invoiceprintid={$INVOICEPRINTID}");
	{rdelim}
