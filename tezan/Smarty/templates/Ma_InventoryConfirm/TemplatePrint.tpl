...
<script type="text/javascript" charset="utf-8">
	...
	{ldelim}
		$(this).dialog({ldelim}id:'print', url:'index.php?module={$MODULE}&action=TemplatePrint&oper=view&record={$RECORD}&invoiceprintid='+templateid+"&pageCurrent={$PAGECURRENT}&pageSize={$PAGESIZE}", title:'打印',width:900,height:600,mask:true,resizable:false,maxable:false{rdelim});
		var printwondiw=window.open('index.php?module={$MODULE}&action=TemplatePrint&oper=view&record={$RECORD}&invoiceprintid='+templateid+"&pageCurrent={$PAGECURRENT}&pageSize={$PAGESIZE}",'打印','width=900,height=600');
		printwondiw.print();
		//printwondiw.close();
	{rdelim}
	...
	{ldelim}
		window.location="/index.php?module={$MODULE}&action=TemplatePrint&oper="+mode+"&record={$RECORD}&invoiceprintid={$INVOICEPRINTID}&pageCurrent={$PAGECURRENT}&pageSize={$PAGESIZE}";
	{rdelim}

	function print_out()
	{ldelim}
		window.open("/index.php?module={$MODULE}&action=TemplatePrint&oper=print&record={$RECORD}&invoiceprintid={$INVOICEPRINTID}&pageCurrent={$PAGECURRENT}&pageSize={$PAGESIZE}");
	{rdelim}
