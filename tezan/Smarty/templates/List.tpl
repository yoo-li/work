				...
				<li>
					<div class="pull-left">
						...
						{foreach item=data from=$LISTVIEW_CHECK_BUTTON}
							...
							<a class="btn btn-default" data-icon="file-excel-o" data-toggle="doexportchecked" href="index.php?mode=Export" data-confirm-msg="确定导出Excel文件吗?">{$APP.LNK_EXPORTEXCEL}</a>
