...
<div class="bjui-pageHeader">
	...
	{*<div class="pull-right" style="margin-right:14px;margin-top:4px;margin-bottom:4px;">*}
		...
		{*<a class="btn btn-default" data-icon="database" data-toggle="dialog" data-mask="true" data-maxable="false" data-height="500" data-title="自定义分类树" href="index.php?module=Ma_Categorys&action=CustomCategorys">自定义套餐包</a>*}
		{*{/if}*}
	{*</div>*}
</div>
