						...
						<td style="padding-right:14px;width:78px;">
							<script type="text/javascript">
								...
								function ajaxsearchFrame(){
									if($.CurrentNavtab.find("#refresh_tree_listview")){
										var paramstr = getPostParams();
										var postBody = "index.php?mode=treeajax&"+paramstr;
										$.CurrentNavtab.find("#refresh_tree_listview").ajaxUrl({url:postBody, loadingmask:true})
									}
								}
								{/literal}
							</script>
...
<div id="refresh_tree_listview" class="bjui-pageContent tableContent">
	...
	<div class="bjui-pageContent tableContent" style="bottom: 30px;overflow: hidden;">
		<div class="panel panel-default" style="float:left;width:60%;height: 100%;overflow-y:auto;">
		...
		<div class="panel panel-default" style="float:left;width:40%;height: 100%;overflow-y:auto;bottom: 30px;">
			<div class="panel-heading">
				<h3 class="panel-title">
