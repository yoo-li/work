...
<div id="agencyfrom_listview_entries" class="bjui-pageContent tableContent" style="left: 30%;width:70%;">
	<div class="bjui-pageContent tableContent" style="bottom: 60px;">
		<div class="panel panel-default" style="float:left;width:60%;height:auto;overflow-y:scroll; ">
			<div class="panel-heading">
				<h3 class="panel-title">
					<a href="#agencyfrom_form_div" data-toggle="collapse">
			...
			<div style="padding:0;" class="panel-body bjui-doc">
				<div id="agencyfrom_form_div" class="collapse in">
				</div>
			</div>
		</div>
		<div class="panel panel-default" style="float:left;width:40%;height:auto;overflow-y:scroll; ">
			<div class="panel-heading">
				<h3 class="panel-title">
					<a href="#hospitalfrom_form_div" data-toggle="collapse">
			...
			<div style="padding:0;" class="panel-body bjui-doc">
				<div id="hospitalfrom_form_div" class="collapse in">
