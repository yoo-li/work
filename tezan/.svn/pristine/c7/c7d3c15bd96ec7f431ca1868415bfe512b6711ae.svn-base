...
$query = XN_Query::create ( 'BigContent' ) ->tag("loginhistorys")
	->filter ( 'type', 'eic', 'loginhistorys');	

if($_REQUEST['author_id'] != '' && $_REQUEST['author_id'] != "")
{
...
if($_REQUEST['author'] != '' && $_REQUEST['author'] != "")
{
	...
	$query->filter ( 'my.user_id', 'in', $users );
...
else
{
	...
	$query->filter ( 'my.user_id', '=', $author );
}
...
$list_entries['user_name'] = array('label' => getTranslatedString('LBL_LIST_USER_NAME'),'sort'=> false,'width' => 20,'align' => "center" );
$list_entries['user_ip'] = array('label' => getTranslatedString('LBL_LIST_USERIP'),'sort'=> true,'width' => 20,'align' => "center" );
$list_entries['login_time'] = array('label' => getTranslatedString('LBL_LIST_SIGNIN'),'sort'=> true,'width' => 20,'align' => "center" );
$list_entries['logout_time'] = array('label' => getTranslatedString('LBL_LIST_SIGNOUT'),'sort'=> true,'width' => 20,'align' => "center" );
$list_entries['status'] = array('label' => getTranslatedString('LBL_LIST_STATUS'),'sort'=> true,'width' => 10,'align' => "center" );
...
$searchpanel['操作用户'] = '<input type="hidden" value="" name="roleid.id" id="roleid_id">
						<span class="wrap_bjui_btn_box" style="position: relative; display: inline-block;">
							<input type="text" name="roleid.name" id="roleid_name" value="全部" size="15" style="padding-right: 15px;" readonly>
							<a class="bjui-lookup" data-toggle="lookupbtn" data-newurl="" data-oldurl="index.php?module=Public&action=SelectRole&mode=checkbox&roleid=" data-url="index.php?module=Public&action=SelectRole&mode=checkbox&roleid=" data-group="roleid" data-maxable="false" data-title="请选择用户"  data-width="300" data-height="300" href="javascript:;" style="height: 22px; line-height: 22px;">
...
$smarty->assign("ACTION", "ListLoginHistory");
