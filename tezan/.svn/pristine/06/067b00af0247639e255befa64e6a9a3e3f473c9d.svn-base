					...
					<nav class="nav">
						<div class="main-nav clearfix">
							<ul class="sf-menu">
								...
								<li class="current"><a class="first-level" href="index.php"><strong>政策法规</strong></a></li>
					...
					<article class="article-detail video-detail">
						...
						<div class="nav-next-prev">
							<ul class="clearfix">
								{if $prev_artical neq ''}
									<li class="prev-page">
										<a href="fagui.php?record={$prev_artical.key}">
											<em>上一篇</em>
								...
								{if $next_artical neq ''}
									<li class="next-page">
										<a href="fagui.php?record={$next_artical.key}">
											<em>下一篇</em>
