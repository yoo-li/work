<?php
	...
	$rechargeablecard_info        = XN_Content::load($_REQUEST['record'], "mall_rechargeablecards", 7);
	$mall_rechargeablecardsstatus = $rechargeablecard_info->my->mall_rechargeablecardsstatus;
	if ($mall_rechargeablecardsstatus == "JustCreated" || $mall_rechargeablecardsstatus == "OffShelf" || $mall_rechargeablecardsstatus == "")
	{
