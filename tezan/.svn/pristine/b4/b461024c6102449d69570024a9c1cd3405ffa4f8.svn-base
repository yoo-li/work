<?php
	...
	$filter                    = array ();
	$filter["productid"]       = base64_encode(serialize(XN_Filter::all(XN_Filter('my.supplierid', '=', $supplierid), XN_Filter('my.approvalstatus', '=', '2'))));
	$filter["salesactivityid"] = base64_encode(serialize(XN_Filter::all(XN_Filter('my.supplierid', '=', $supplierid), XN_Filter('my.approvalstatus', '=', '2'))));
	$filter["newsid"]          = base64_encode(serialize(XN_Filter::all(XN_Filter('my.supplierid', '=', $supplierid), XN_Filter('my.approvalstatus', '=', '2'))));
