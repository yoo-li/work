...
class Mall_RechargeableCards extends CRMEntity {
	
	public $table_name = 'mall_rechargeablecards';
	public $datatype='7';
	public $table_index= 'id';
	public $tab_name = Array('mall_rechargeablecards');
	public $tab_name_index = Array('mall_rechargeablecards'=>'id');
	public $customFieldTable = Array('mall_rechargeablecards', 'id');
    ...
    function Mall_RechargeableCards() {
		
		$this->column_fields = getColumnFields('Mall_RechargeableCards');
	}
