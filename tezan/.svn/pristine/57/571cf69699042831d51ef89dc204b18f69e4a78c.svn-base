...
//<<<<<<<<customview>>>>>>>>>
	...
	$searchuser_panel = $searchpanel['查找用户']; 
	unset($searchpanel['查找用户']);
	$status_panel = $searchpanel['状态']; 
	unset($searchpanel['状态']);
	...
	$searchpanel['状态'] = $status_panel;
	$searchpanel['查找用户'] = $searchuser_panel; 
