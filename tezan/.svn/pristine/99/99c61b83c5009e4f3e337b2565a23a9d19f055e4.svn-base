...
{
	include ('modules/Mall_SmkReimburses/SheetExportExcel.php');
	die();
}
...
//$users = XN_Query::create ( 'Content' )->tag('Mall_SmkReimburses')
//    ->filter ( 'type', 'eic', 'Mall_SmkReimburses')
//    ->end(1)
//    ->execute();
//var_dump($users[0]->my->returnedgoodsapplyid);
//exit;
//$smk_list = XN_Content::create('Mall_SmkReimburses');
//$smk_list->my->supplierid= '12352'; // 商家
//$smk_list->my->orderid = '68535'; // 订单
//$smk_list->my->returnedgoodsapplyid = '1080'; // 退货申请
//$smk_list->my->profileid = '2f23rzsjasz'; // 会员
//$smk_list->my->paymentid = '393'; // 支付记录
//$smk_list->my->payment = '市民卡'; // 支付平台
//$smk_list->my->amountpayable = '30'; // 退款金额
//$smk_list->my->paymentamount = '70'; // 实际支付
//$smk_list->my->smkmoney = '20'; // 卡支付
//$smk_list->my->usemoney = '10'; // 余额支付
//$smk_list->my->sumorderstotal = '100'; // 订单总金额
//$smk_list->my->allreturned = 'yes'; // 全退
//$smk_list->my->mall_reimbursestatus = '已退款'; // 退款状态
//$smk_list->my->returngoodsdate = '2017-05-24 13:30'; // 退款时间
//$smk_list->my->addtime = '2017-05-24 13:30'; // 创建时间
//$smk_list->my->deleted = 0;
//$smk_list->save('Mall_SmkReimburses');
