<?php
	...
	{
		$filter["wxid"] = base64_encode(serialize(XN_Filter::any(XN_Filter('my.supplierid', '=', $supplierid))));
	}
	else
	{
		$filter["wxid"] = base64_encode(serialize(XN_Filter::any(XN_Filter('my.supplierid', '=', '0'))));
	}
