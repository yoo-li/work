...
<div class="bjui-pageContent tableContent" style="overflow:hidden;">
	<form id="salesEditViewForm" method="post" action="index.php" callback="{$MODULE|@strtolower}_validate" data-toggle="validate" data-validator-option="{ldelim}focusCleanup:true,timely:true{rdelim}" data-alertmsg="false">
