...
<div class="bjui-pageFooter">
	<ul>
		...
		{if $SELECTMODE eq 'checkbox'}
		<li>
			<a type="button" class="btn btn-green" href="index.php?module={$MODULE}&action=ImportUser" data-callback="createcentralizedpurchasing_callback" data-toggle="doajaxchecked" data-group="ids" data-icon="check-square-o" data-loadingmask="true" data-warn="{$SELECTWARN}">导入用户</a>
		</li>
		{/if}
	</ul>
</div>