...
<div class="bjui-pageContent">
    ...
    <form action="index.php?module=Mall_Finance&action=april_special " method="post">
        <div style="padding: 2px 0px;">
            <span style="display:inline-block;width:150px;">16.供应商结算明细表(四月份/伍月)</span>
            <input class="btn btn-default" data-icon="file-excel-o" type="submit" name="" value="导出EXCEL" onclick="return  btn1( )">   </input>&nbsp;&nbsp;
    ...
    <form action="index.php?module=Mall_Finance&action=april_special_list " method="post">
        <div style="padding: 2px 0px;">
            <span style="display:inline-block;width:150px;">16.供应商结算合计表(四月份/伍月)</span>
            <input class="btn btn-default" data-icon="file-excel-o" type="submit" name="" value="导出EXCEL" onclick="return  btn1( )">   </input>&nbsp;&nbsp;
            <a  href="index.php?module=Mall_Finance&action=april_special_list" target="_blank" class="btn btn-default" onclick=" return btn2(this )">打印</a><br>
            <input type="hidden" name="starttime" value="" class="start1" >  </input>
            <input type="hidden" name="endtime" value="" class="end1">  </input>
        </div>
    </form>
