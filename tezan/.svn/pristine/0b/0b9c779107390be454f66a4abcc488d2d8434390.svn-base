 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/vtiger_crm/sugarcrm/modules/CustomView/language/zh_cn.lang.php,v 1.0 2011/04/10 06:50:39 rank Exp $
 * Description:  Defines the Chinese language pack for the CustomView module.
 * Portions created by SugarCRM are Copyright (C) SugarCRM, Inc.
 * All Rights Reserved.
...
'LBL_AF_HDR2' => '您可以在第三个字段输入多个条件，用"or"分开 ',
