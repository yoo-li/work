...
if(isset($_REQUEST["ids"]) && $_REQUEST["ids"] != "" )
{
	 ...
	 {
	 	if ($info->my->supplier_takecashsstatus != '待处理')
	 	{ 
			echo '{"statusCode":"300","message":"选择中包含了非“待处理”的申请！"}';
	 		die();	 
		}
	}
	 foreach($list_result as $info)
	 {
	 	if ($info->my->supplier_takecashsstatus == '待处理')
	 	{  
	            $info->my->examinedatetime = date("Y-m-d H:i"); 
	            $info->my->examinant = XN_Profile::$VIEWER;
				$info->my->supplier_takecashsstatus = '处理中';
