...
// $searchpanel["开户银行"]='<div style="display:block;float:left;width:200px;">
// 							<select id="search_bank" name="search_bank">
...
if(count($statistics)>0)
    $smarty->assign("CUSTOMSHOWMSG", "<font color=blue>&nbsp;&nbsp;&nbsp;&nbsp;提现金额总计：".$statistics[0]->my->amount . "</font>");
*/
