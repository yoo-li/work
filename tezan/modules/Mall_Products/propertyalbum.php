...
if (isset($_REQUEST['record']) && $_REQUEST['record'] != "" && isset($_REQUEST['cid']) && $_REQUEST['cid'] != "" && isset($_REQUEST['mode']) && $_REQUEST['mode'] == "edit")
{
    ...
    $ONCLICK = '
        var select_imgurl=$("input[name^=\'propertyimg_\']:checked").val();
        var cid="'.$cid.'";
        var record="'.$record.'";
        var img_url=$("input[name^=\'propertyimg_\']:checked").val();
        if(img_url!=""){
            $("#complexpice_img_"+cid).val(img_url);
            $("#complexpice_img_link_"+cid).attr("href",img_url).css("display","inline");
            $("#complexpice_img_view_"+cid).attr("src",img_url);
            $("#complexpice_img_select_"+cid).css("display","none");
            $("#complexpice_img_delete_"+cid).css("display","inline");
