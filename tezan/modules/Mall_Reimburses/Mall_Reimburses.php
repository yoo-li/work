...
class Mall_Reimburses extends CRMEntity {
	
	public $table_name = 'mall_reimburses';
	public $datatype = '7';
	public $table_index= 'id';
	public $tab_name = Array('mall_reimburses');
	public $tab_name_index = Array('mall_reimburses'=>'id');
	public $customFieldTable = Array('mall_reimburses', 'id');
	public $column_fields = Array();
	public $sortby_fields = Array('businesseid','orderid','returnedgoodsapplyid','profileid','returngoodsdate','payment','paymentaccount','actuallypaid','amountpayable','mall_reimbursestatus');
    ...
    function Mall_Reimburses() {
		
		$this->column_fields = getColumnFields('Mall_Reimburses');
	}
