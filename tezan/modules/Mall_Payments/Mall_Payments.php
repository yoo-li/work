...
class Mall_Payments extends CRMEntity {
	
	public $table_name = 'mall_payments';
    public $datatype='7';
	public $table_index= 'id';
	public $tab_name = Array('mall_payments');
	public $tab_name_index = Array('mall_payments'=>'id');
	public $customFieldTable = Array('mall_payments', 'id');
    ...
    function Mall_Payments() {
		
		$this->column_fields = getColumnFields('Mall_Payments');
	}
