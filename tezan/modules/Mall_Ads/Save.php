...
if(!isset($focus->column_fields[strtolower($currentModule). 'status']) || $focus->column_fields[strtolower($currentModule). 'status'] == '')
{
...
$f2cadlinktarget = $focus->column_fields['f2cadlinktarget'];


if ($f2cadlinktarget == '0')
{ 
	$focus->column_fields['salesactivityid'] = '';
	$focus->column_fields['newsid'] = ''; 
}
else if ($f2cadlinktarget == '1')
{
	$focus->column_fields['productid'] = ''; 
	$focus->column_fields['newsid'] = ''; 
}
else
{
