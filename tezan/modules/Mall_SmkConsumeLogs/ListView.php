...
//$users = XN_Query::create ( 'Content' )->tag('Mall_SmkConsumeLogs')
//    ->filter ( 'type', 'eic', 'Mall_SmkConsumeLogs')
//    ->end(1)
//    ->execute();
//var_dump($users[0]->my->supplierid);
//exit;
//$smk_list = XN_Content::create('Mall_SmkConsumeLogs');
//$smk_list->my->profileid = '2f23rzsjasz'; // 用户
...
//$smk_list->my->postage = '7'; // 邮费
//$smk_list->my->endtime = '2017-05-24 13:30'; // 消费时间
//$smk_list->my->consumelogsstatus = '混合支付'; // 状态
//$smk_list->my->deleted = 0;
//$smk_list->save('Mall_SmkConsumeLogs');
//
//die;
