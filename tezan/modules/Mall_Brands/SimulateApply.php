    ...
    isset($_REQUEST['type']) && $_REQUEST['type'] == "submit" )
{
    try {
        ...
        $focus->column_fields['approvalstatus'] = '2';
        $focus->column_fields[$status] = 'Agree';
        $focus->column_fields['finishapprover'] = XN_Profile::$VIEWER;
        $focus->column_fields['submitapprovalreplydatetime'] = date("Y-m-d H:i");
