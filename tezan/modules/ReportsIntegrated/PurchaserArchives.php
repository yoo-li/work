...
$query->filter ( 'my.sale_id', '=', $supplierid);
...
$list_entries['nickname'] = array('label' => '购货者名称','sort'=> false,'width' => 12,'align' => "center" );
...
function getStdOutput($list_result, $list_entries)
{
	...
	foreach($contents as $info)
	{
		...
		foreach(array_keys($list_entries) as $field)
		{
			...
			{ 
				$viewcategorys = '<a rel="edit" target="navTab" href="index.php?module='.$types[$info->id].'&action=EditView&record='.$ids[$info->id].'&type=purchaser" title="查看购货者档案" data-toggle="navtab" data-fresh="true" data-id="edit" data-title="购货者档案"><i class="fa fa-file-text-o"></i></a>';
...
$searchpanel['操作日期'] = '<a href="javascript:;" id="reportsintegrated_published_all" for="reportsintegrated_published_period" '.(($thistype == 'all'?'class="over"':'')).' title="全部">全部</a>
						...
						<br/>
						<a  class="btn btn-default" data-toggle="dialog" data-icon="print" data-mask="true" data-maxable="false" data-resizable="false" data-width="900" data-height="600" href="index.php?module='.$module.'&action=PurchaserArchivesPrint&oper=view&record='.$focus->id.'" > 打印</a>';
...
$smarty->assign("ACTION", "PurchaserArchives");
