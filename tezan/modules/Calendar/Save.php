...
$personmans = $_REQUEST['personman_id'];
$personmans = str_replace(";",",",$personmans);
$personmans = explode(",",trim($personmans,','));
array_filter($personmans);
$_REQUEST['personman_id'] = $personmans;
...
if (isset($_SESSION['source']) && $_SESSION['source'] == 'MainPage')
{
	echo '{"statusCode":200,"message":null,"divid":"stuff_calendar_form_ajax_div","closeCurrent":"true","forward":null}';
