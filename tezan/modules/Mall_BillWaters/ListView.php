...
if(isset($_REQUEST["billwatertype"]) && $_REQUEST["billwatertype"] != ""){
   
        $query->filter('my.billwatertype', '=', $_REQUEST["billwatertype"]);
        $statistics->filter('my.billwatertype', '=', $_REQUEST["billwatertype"]);
