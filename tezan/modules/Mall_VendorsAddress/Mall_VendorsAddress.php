...
class Mall_VendorsAddress extends CRMEntity {
	
	public $table_name = 'mall_vendorsaddress';
	public $table_index= 'id';
	public $tab_name = Array('mall_vendorsaddress');
	public $tab_name_index = Array('mall_vendorsaddress'=>'id');
	public $customFieldTable = Array('mall_vendorsaddress', 'id');
	public $column_fields = Array();
	public $sortby_fields = Array('mall_vendorsaddress_no','brand_name','site_url','brand_desc','is_show');
    ...
    function Mall_VendorsAddress() {
		
		$this->column_fields = getColumnFields('Mall_VendorsAddress');
	}
