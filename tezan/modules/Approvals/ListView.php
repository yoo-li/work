...
//<<<<<<<<customview>>>>>>>>>
    ...
    $proxyapproval = XN_Filter("my.proxyapproval", '=', XN_Profile::$VIEWER);
    $from_userid   = XN_Filter("my.sourcer", '=', XN_Profile::$VIEWER);
    $userid        = XN_Filter("my.userid", '=', XN_Profile::$VIEWER);
    $query->filter(XN_Filter::any($proxyapproval, $from_userid, $userid));
