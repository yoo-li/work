<?php
	...
	global $current_user, $supplierusertype, $relation_id,$supplierid;
//	if (($focus->approvalstatus == '2' || $focus->approvalstatus == '0'|| $focus->approvalstatus == '') && ($supplierusertype == "superadmin" || $supplierusertype == "admin" || $focus->column_fields['author'] == XN_Profile::$VIEWER))
//	{
...
//	}
	...
	$smarty->display($module."/salesEditView.tpl");