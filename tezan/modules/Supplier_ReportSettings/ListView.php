...
//<<<<<<<<<customview>>>>>>>>>
    ...
    //形成搜索字段
    global $user_type,$user_type_id,$relation_id;
    ...
    foreach($listview_entries as $key => $item){
        $reporttypeid = $item["reporttype"];
        $listview_entries[$key]["reporttype"] = $reporttype[$reporttypeid];
    }
