    ...
    isset($_REQUEST['type']) && $_REQUEST['type'] == "submit" )
{
    try {
		...
		$loadcontent->my->vendorsettlementstatus = '1';
	    ...
	    foreach($mall_settlementorders as $mall_settlementorder_info){
	        $mall_settlementorder_info->my->mall_settlementordersstatus = 'Submit';
			$mall_settlementorder_info->my->vendorsettlementstatus = '2';
