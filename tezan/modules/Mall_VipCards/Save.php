...
if($focus->column_fields['businesseid'] == '' && $focus->mode == "create")
{
		$focus->column_fields['businesseid'] = $businesseid;
}
if($focus->column_fields[strtolower($currentModule). 'status'] == '' && $focus->mode == "create")
{
	...
	$focus->column_fields['profileid'] = '';
	$focus->column_fields['lastsingletime'] = '';
	$focus->column_fields['lastsettletime'] = ''; 
	$focus->column_fields['vipcardhidden'] = '0'; 
