...
if (isset($_REQUEST['authorizedperson_id']) && $_REQUEST['authorizedperson_id'] != "")
{
	$personmans = $_REQUEST['authorizedperson_id'];
	$personmans = str_replace(";",",",$personmans);
	$personmans = explode(",",trim($personmans,','));
	array_unique($personmans);
	$focus->column_fields['authorizedperson'] = $personmans;
}  
