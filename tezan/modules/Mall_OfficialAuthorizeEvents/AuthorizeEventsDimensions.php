...
{
    $tag = "mall_officialauthorizeevents_details_".$supplierid;
}
else
{
    $tag = "mall_officialauthorizeevents_details";
}
...
$dimensiontypename = array(
    array("key"=>"消费商户类别","value"=>array("茶厂","超市","会所","咖啡茶座","酒楼","餐饮公司","外卖","办公用品店")),
