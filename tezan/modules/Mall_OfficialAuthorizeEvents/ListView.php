...
if(isset($changeArray) &&is_array($changeArray)){
    $listview_header = $controller->getListViewHeader($focus,$currentModule,"",$sorder,$order_by,$changeArray);   //引入標題
...
{
//    AuthorizationTitle 授權標題　
//    var_dump($listview_entries);die();
//    var_dump($listview_entries[439297 ][pid]);
//    var_dump( $list_result[0] );
//    var_dump( $list_result[0] ); die();
//    foreach ($list_result as $value){
//        echo $value->my->pid;
//    }
////    var_dump( $list_result[0]->my->pid);
//    die;
