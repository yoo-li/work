<?php
	...
	if (!function_exists('return_application_language'))
	{
		...
		{
			global $app_strings;
			$language_file = '/include/language/'.$language.'.lang.php';  //zh_cn.lang.php
	...
	if (!function_exists('cn2pinyin'))
	{

		function cn2pinyin($_String, $_Code = 'utf-8')
		{
