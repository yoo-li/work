...
<div id="pullrefresh" class="mui-content mui-scroll-wrapper" style="padding-top: 120px;">
    <div class="mui-collapse-content">
        <form class="mui-input-group">
            ...
            {foreach name=blocks key=header item=data from=$inventoryborrowout}
        ...
        if (checks(mybarcodes, result)) {
            ...
            if (contains(mybarcodes, result)) {
                ...
                if (testdiv) {
                    ...
                    alert("找不到编码为" + itemcodes + "批号为" + batchcodes + "的未出货产品");
                    return;
                }
            }
...
//        }
    ...
    function savedata(str1, str2) {
        ...
        mui.ajax({
            ...
            traditional: true,
            dataType: "json",
            url: "save_inventoryborrowout.php",
