    ...
    <div class="mui-collapse-content">
        <form class="mui-input-group">
 	    ...
 	    <div id="div_find">
            ...
            {foreach name=blocks key=header item=data from=$inventorybackout}
...
//            alert(mybarcodes[i]+"======"+bararr.get(mybarcodes[i]));
    ...
    function getdata(obj) {
        ...
        mui.ajax({
            ...
            dataType: "json",
            url: "find.php",
            data: {"record": record, "barcode": obj.value,"mode":"inventorybackout"},
            success: function (data) {
