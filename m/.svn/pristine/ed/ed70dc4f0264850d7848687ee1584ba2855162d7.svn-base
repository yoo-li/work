		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
            ...
            <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
 					<a class="mui-control-item iconfont icon-daishenpi button-color mui-active" href="pendingapproval.php">&nbsp;待审批</a> 
					<a class="mui-control-item iconfont icon-shenpijilu button-color" href="approvalrecord.php">&nbsp;审批记录</a>
 				</div> 
            </div>
		</header> 
					...
					{else}
						<div class="mui-card" style="margin: 3px 3px;">  
				   			    ...
				   			    <div class="mui-input-row">
	                                <label style="height:45px;font-weight:bold;">审批选择:</label>
						                   <span><input type="radio" value="Agree" id="radio-1" name="reply" checked >
						                   <label style="width:100px;padding: 10px 5px;" class="radio" for="radio-1">审批同意</label></span>
						                   <span><input type="radio" value="Disagree" id="radio-2" name="reply" >
						                   <label style="width:100px;padding: 10px 5px;" class="radio" for="radio-2">审批不同意</label></span>  
	                            </div> 
		 					 
			 					<div class="mui-input-row">
			 						<label style="height:65px;font-weight:bold;">审批意见:</label>
	   				    ...
	   				    <div class="mui-card" style="margin: 3px 3px;">
					   	   <div class="mui-content-padded" style="height:35px;line-height:35px;">
							   ...
							   <span class="mui-badge mui-badge-purple" style="background:{$supplier_info.navigationbarcolor}">{$noofrows}</span>&nbsp;条
								   <button id="nextapproval" data-approvalid="{$approval_info.approvalid}" type="button" class="mui-btn mui-btn-royal  mui-pull-right" style="background:{$supplier_info.navigationbarcolor}"><span class="mui-icon iconfont icon-next" ></span>&nbsp;下一条</button> 
						    </div> 
	   				    </div>
					    {/if}
						<div class="mui-card" style="margin: 3px 3px;">  
	...
	mui.ready(function ()
			  {
				  ...
				  { 
					  ...
					  mui.openWindow({
										 url: 'pendingapproval.php?nextapprovalid='+approvalid,
										 id: 'info'
									 });
				  }); 
