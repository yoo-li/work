    ...
    <td>
      <table class="maintable" cellspacing=0 cellpadding=0 width="96%" bgcolor=#ffffff border=0>
        ...
        <tr>
          ...
          <td width=108 background="/public/images/rbox/rbox_2.gif"  height=20></td>
          <td width=56><img height=20 src="/public/images/rbox/rbox_ring.gif" width=56></td>
          <td width=100 background="/public/images/rbox/rbox_2.gif"></td>
          <td width=56><img height=20 src="/public/images/rbox/rbox_ring.gif" width=56></td>
          <td width=108 background="/public/images/rbox/rbox_2.gif"></td>
          <td width=20  height=20></td>
	    </tr>
        <tr>
