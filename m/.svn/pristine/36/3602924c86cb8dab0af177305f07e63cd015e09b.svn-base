						...
						{if   $noofrows gt 1}
							<div class="mui-card" style="margin: 3px 3px;">
								<div class="mui-content-padded" style="height:35px;line-height:35px;">
									...
									{*{if $flag eq 0}*}
										<button id="beforeapproval" data-approvalid="{$officialtreat.record}" type="button" class="mui-btn mui-btn-royal  mui-pull-right" style="background:{$supplier_info.navigationbarcolor};margin-right:5px">
