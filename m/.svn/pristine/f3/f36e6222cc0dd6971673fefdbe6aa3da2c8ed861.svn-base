...
//    XN_REST::$LOCAL_API_HOST_PORT               = $_SERVER['HTTP_X_NING_LOCAL_API_HOST_PORT'];
    ...
    $purchaseorders                             = XN_Query::create("Content")
        ->tag("ma_incheckstorage")
        ->filter("type", "eic", "ma_incheckstorage")
    ...
    {
        $purchaseorders_info  = XN_Content::load($info->my->ma_purchaseorders, "ma_purchaseorders");
        $ma_purchaseorders_no = $purchaseorders_info->my->ma_purchaseorders_no;
