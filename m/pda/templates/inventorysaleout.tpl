            ...
            <ul id="orders" class="mui-table-view" style="padding-top: 5px;text-align:center;">
                {foreach name=blocks key=header item=data from=$inventorysaleout}
                    <li class="mui-table-view-cell">
                        <a href="sa_inventorysaleout.php?record={$data.saleorderid}&no={$data.ma_saleorders_no}&profileid={$profileid}&supplierid={$supplierid}&inventorysaleoutid={$data.id}&suppliername={$suppliername}"
