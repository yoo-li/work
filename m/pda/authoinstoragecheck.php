...
$purchaseorders = XN_Query::create("Content")
					->tag("ma_authoinstoragecheck")
					->filter("type", "eic", "ma_authoinstoragecheck")
...
//					->filter("my.receipt_id","=",$supplierid)
	...
	foreach($purchaseorders as $info){
		$purchaseorders_info=XN_Content::load($info->my->ma_inventoryauthoout,"ma_inventoryauthoout");
		$ma_purchaseorders_no=$purchaseorders_info->my->ma_inventoryauthoout_no;
