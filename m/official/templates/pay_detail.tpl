					     ...
					     <div class="mui-card" style="margin: 3px 3px;">
		                    <ul class="mui-table-view" style="padding-top: 5px;padding-bottom: 5px;">
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                    <label>宴请编号:</label>
	                                    <input value="{$list.mall_officialtreats_no}" type="text" style="font-size: 12px;"
	                                           class="mui-input-clear required" disabled >
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                    <label>提交人:</label>
	                                    <input value="{$list.profileid}" type="text" style="font-size: 12px;"
	                                           class="mui-input-clear required" disabled>
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                   <label>实际宴请地点:</label>
	                                   <input value="{$list.address}" type="text" style="font-size: 12px;" class="mui-input-clear required" disabled>
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                   <label>联系人:</label>
	                                   <input value="{$list.contact}" type="text" style="font-size: 12px;" class="mui-input-clear required" disabled>
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                   <label>联系电话:</label>
	                                   <input value="{$list.mobile}" type="text" style="font-size: 12px;" class="mui-input-clear required" disabled>
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                   <label>商户地址:</label>
	                                   <input value="{$list.companyaddress}" type="text" style="font-size: 12px;" class="mui-input-clear required" disabled>
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                   <label>开户行:</label>
	                                   <input value="{$list.bankname}" type="text" style="font-size: 12px;" class="mui-input-clear required" disabled>
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                   <label>开户名:</label>
	                                   <input value="{$list.accountname}" type="text" style="font-size: 12px;" class="mui-input-clear required" disabled>
	                                </div>
	                                <div class="mui-input-row" style="margin-top:3px;">
	                                   <label>银行账号:</label>
	                                   <input value="{$list.bankaccount}" type="text" style="font-size: 12px;" class="mui-input-clear required" disabled>
	                                </div>
