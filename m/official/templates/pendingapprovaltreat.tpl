					   	   ...
					   	   <div class="mui-content-padded" style="height:35px;line-height:35px;">
							   ...
							   <span class="mui-badge mui-badge-purple" style="background:#1bc1f8">{$num}/{$noofrows}</span>&nbsp;条
								   <button id="nextapproval" data-approvalid="{$officialtreat.record}" type="button" class="mui-btn mui-btn-royal  mui-pull-right" style="background:{$supplier_info.navigationbarcolor}">
 								   ...
 								   <button id="beforeapproval" data-approvalid="{$officialtreat.record}"
										   type="button" class="mui-btn mui-btn-royal  mui-pull-right" style="background:{$supplier_info.navigationbarcolor};margin-right:5px">
