...
//测试s
$profileid = 'gag11zv7ugx'; //丁香花
$profileid = 'naj92b7j704'; //西北
$profileid = '17um90swy0n'; //大连 kd9czbu60d5
$profileid = 'kd9czbu60d5'; //003
$profileid = 'ex21hjiey5g';//001
//测试e
//通过查询数据库获取店铺id
...
//    ->filter ( 'my.mall_officialauthorizeeventsstatus', '=', 'Submit' ) //onlicne
    ->filter ( 'my.mall_officialauthorizeeventsstatus', '=', 'JustCreated' ) //onlicne
    ->filter ( 'my.deleted', '=', '0' )
