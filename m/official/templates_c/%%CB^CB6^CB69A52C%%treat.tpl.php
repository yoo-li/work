<?php /* Smarty version 2.6.18, created on 2017-08-31 17:55:18
         compiled from treat.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'treat.tpl', 259, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="mui-inner-wrap">
	...
	<div id="pullrefresh" class="mui-content mui-scroll-wrapper" style="padding-top: 85px;">
		<div class="mui-scroll">
            <?php if (count($this->_tpl_vars['officialauthorizeevents']) == 1): ?>
...
?>
										<option type="hidden" class="mui-input-clear" value="<?php echo $this->_tpl_vars['foo']; ?>
" id="address1" blur = get_address() ><?php echo $this->_tpl_vars['foo']; ?>
</option>
...
<script type="text/javascript">
    ...
    var authorizeevents = [
        <?php $_from = $this->_tpl_vars['officialauthorizeevents']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['officialauthorizeevents'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['officialauthorizeevents']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['officialauthorizeeventid'] => $this->_tpl_vars['officialauthorizeevent_info']):
        $this->_foreach['officialauthorizeevents']['iteration']++;
?>
        { value: '<?php echo $this->_tpl_vars['officialauthorizeeventid']; ?>
', text: '<?php echo $this->_tpl_vars['officialauthorizeevent_info']['authorizationtitle']; ?>
'},
        <?php endforeach; endif; unset($_from); ?>
	];
    var authorizeevents_jscode = [<?php echo $this->_tpl_vars['officialauthorizeevents_encode']; ?>
];
    var sign = <?php echo $this->_tpl_vars['sign']; ?>
