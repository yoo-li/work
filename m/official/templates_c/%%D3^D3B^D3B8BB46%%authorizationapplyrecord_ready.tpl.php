<?php /* Smarty version 2.6.18, created on 2017-08-27 11:30:52
         compiled from authorizationapplyrecord_ready.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
            ...
            <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
					...
					<a class="mui-control-item iconfont icon-shenpijilu button-color mui-active" href="authorizationapplyrecord_ready.php">&nbsp;授权清单</a>
 				</div>
            </div>
		</header> 
	...
	mui.ready(function ()
			  {
				  ...
				  mui(\'.mui-table-view\').on(\'tap\', \'a.deleteorder\', function (e)
				  {
					  ...
					  swal({
						   ...
						   {
							   window.location.href = \'authorizationapplyrecord_ready.php?type=delete&record=\' + treatid;
						   });
				  });
			  }); 
		  	...
		  	function order_html(v)
		  	{
				...
				{
					sb.append(\'						<a class="mui-icon iconfont icon-quxiao deleteorder button-color myfont-color" data-id="\' + v.record + \'" href="#">&nbsp;取消授权</a> \');
				} 
				sb.append(\'					</div> \');
		  		sb.append(\'                </li>\');
				...
				sb.append(\'				 <li class="mui-table-view-cell order-link-cell"> \'); 
				sb.append(\'					<div class="mui-media-body  mui-pull-left">\');
				if(v.mall_officialauthorizeeventsstatus == 0){
                    sb.append(\'						 <p class="mui-icon iconfont myfont-color" style="font-size: 14px;padding-left:55px;color:#cc3300;">状态：未上线</p>\');
				}else{
                    sb.append(\'						 <p class="mui-icon iconfont myfont-color" style="font-size: 14px;padding-left:55px;color:#cc3300;">状态：未上线 </p>\');
				}
//				sb.append(\'						 <p class="mui-icon iconfont" style="font-size: 14px;padding-left:55px;color:#cc3300;">状++++态：\' + v.status + \'</p>\');
				sb.append(\'					</div> \');
				sb.append(\'              </li>\');
		  		sb.append(\' 	 	</ul>\');
		  		sb.append(\'</div>\');
		  	...
		  	function add_more()
		  	{
		  		...
		  		mui.ajax({
		  					 type: \'POST\',
		  					 url: "authorizationapplyrecord_ready.php",
