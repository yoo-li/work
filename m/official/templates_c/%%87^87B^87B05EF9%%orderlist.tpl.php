<?php /* Smarty version 2.6.18, created on 2017-08-15 13:41:15
	...
	mui.ready(function ()
		  	...
		  	function order_html(v)
		  	{
				...
				sb.append(\'							<div class="mui-media-body">\');
		  		sb.append(\'								<p class="mui-ellipsis" style="color:#333">下单时间：\' + v.published + \'</p>\'); 
				sb.append(\'								<p class="mui-ellipsis" style="color:#333">总金额：\' + v.sumorderstotal + \'</p>\');   
		  		sb.append(\'							</div> \'); 
				sb.append(\'					 </a>\');
		  		sb.append(\'				 </li> \');   
		  		sb.append(\' 	 	</ul>\');
		  	...
		  	function order_empty_html()
		  	{
		  		...
		  		sb.append(\'					      <p class="msgbody">您还没有购物记录！<br>\');
	  			sb.append(\'							  <br> \');
				sb.append(\'						  </p>  \');
		  		sb.append(\' </div>\');
		  		return sb.toString();
