<?php /* Smarty version 2.6.18, created on 2017-08-16 11:23:30
         compiled from pendingopinionorder.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'pendingopinionorder.tpl', 115, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
            ...
            <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
 					<a class="mui-control-item iconfont icon-daishenpi button-color mui-active" href="pendingopinionorder.php">&nbsp;发表意见</a> 
					<a class="mui-control-item iconfont icon-shenpijilu button-color" href="opinionrecord.php?type=order">&nbsp;意见记录</a>
 				</div> 
            </div> 
		</header> 
	...
	mui.ready(function ()
			  {
				  ...
				  { 
					  ...
					  mui.openWindow({
										 url: \'pendingopinionorder.php?beforeapprovalid=\'+approvalid+\'&num=\'+num,
										 id: \'info\'
									 });
				  });
//				  -----
                  mui(\'.mui-table-view\').on(\'tap\', \'button#nextapproval\', function (e)
                  {
                      var approvalid = this.getAttribute(\'data-approvalid\');
                      mui.openWindow({
                          url: \'pendingopinionorder.php?nextapprovalid=\'+approvalid+\'&num=\'+num,
                          id: \'info\'
                      });
                  });
//				  ++++++++++++++
                      ...
                      swal({
                          ...
                          confirmButtonColor: "#ec6c62"
						    ...
						    mui.ajax({
										 ...
										 {
     			  						       mui.openWindow({
     			  											 url: \'opinionrecord.php?type=order\',
     			  											 id: \'info\'
     			  										 });
										 }
										 else
