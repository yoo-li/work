<?php /* Smarty version 2.6.18, created on 2017-08-28 14:44:00
         compiled from authorizationapply1.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
		...
		<div class="mui-title mui-content tit-sortbar" id="sortbar">
			<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
				<a class="mui-control-item iconfont icon-daishenpi button-color mui-active" href="authorizationapply1.php">&nbsp;提议上级授权</a>
				<a class="mui-control-item iconfont icon-shenpijilu button-color" href="javascript:;">&nbsp;授权提议清单</a>
			</div>
		</div>
	</header>
