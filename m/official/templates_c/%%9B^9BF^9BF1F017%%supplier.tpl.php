<?php /* Smarty version 2.6.18, created on 2017-08-11 11:34:53
         compiled from supplier.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	                             ...
	                             <li class="mui-table-view-cell">
	                                 <a href="pendingapproval.php" class="mui-navigate-right">
										...
										<div class="mui-media-body  mui-pull-right" style="color:#888;padding-right:20px;">
											<?php if ($this->_tpl_vars['badges']['centerapprovals'] > 0): ?><span class="mui-badge mui-badge-danger"><?php echo $this->_tpl_vars['badges']['centerapprovals']; ?>
</span><?php endif; ?>  查看我的审批
										</div>
									</a>
	                             </li>
	                             <li class="mui-table-view-cell">
	                                 <a href="approval.php" class="mui-navigate-right">
										...
										<div class="mui-media-body  mui-pull-right" style="color:#888;padding-right:20px;">
											<?php if ($this->_tpl_vars['badges']['approval'] > 0): ?><span class="mui-badge mui-badge-danger"><?php echo $this->_tpl_vars['badges']['approval']; ?>
</span><?php endif; ?>  查看待我审核
										</div>
									</a>
	                             </li>
