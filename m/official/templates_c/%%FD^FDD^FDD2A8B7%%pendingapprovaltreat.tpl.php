<?php /* Smarty version 2.6.18, created on 2017-09-01 14:53:45
         compiled from pendingapprovaltreat.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'pendingapprovaltreat.tpl', 115, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
            ...
            <div class="mui-title mui-content tit-sortbar" id="sortbar">
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
 					<a class="mui-control-item iconfont icon-daishenpi button-color mui-active" href="pendingapprovaltreat.php">&nbsp;审核</a>
					<a class="mui-control-item iconfont icon-shenpijilu button-color" href="approvalrecord.php?type=treat">&nbsp;审核记录</a>
 				</div>
            </div>
		</header>
...
" type="hidden">
				   			    <div class="mui-input-row">
	                                <label style="height:45px;font-weight:bold;">审核选择:</label>
						                   ...
						                   <label style="width:100px;padding: 10px 5px;" class="radio_1" for="radio-1">审核同意</label></span>
						                   <span><input type="radio" value="Disagree" id="radio-2" name="reply" >
						                   <label style="width:100px;padding: 10px 5px;" class="radio_2" for="radio-2">审核不同意</label></span>
						                   <div class="mui-input-row">
			                                   <label class="my_advice">同意 :</label>
			                                   <input type="text" id="values" style="font-size: 12px;width:70%" placeholder="审核意见" class="mui-input-clear required">
	                                		</div>
	                            </div>
					    </div>
	  				    ...
	  				    <div class="mui-card mui-btn-my" style="margin: 3px 3px;background: <?php echo $this->_tpl_vars['supplier_info']['navigationbarcolor']; ?>
;">
	...
	mui.ready(function ()
			  {
				  ...
				  mui(\'.mui-table-view\').on(\'tap\', \'button#nextapproval\', function (e)
				  {
					  ...
					  mui.openWindow({
										 url: \'pendingapprovaltreat.php?nextapprovalid=\'+approvalid+\'&num=\'+num,
										 id: \'info\'
									 });
				  });
                  mui(\'.mui-table-view\').on(\'tap\', \'button#beforeapproval\', function (e)
                  {
                      var approvalid = this.getAttribute(\'data-approvalid\');
                      mui.openWindow({
                          url: \'pendingapprovaltreat.php?beforeapprovalid=\'+approvalid+\'&num=\'+num,
                          id: \'info\'
                      });
                  });
					//点击保存审核
                  mui(\'.mui-table-view\').on(\'tap\', \'a#saveapproval\', function (e)
				  {
                      ...
                      swal({
                          ...
                          confirmButtonColor: "#ec6c62"
							...
							var postbody = \'type=submit&approvalid=\' + approvalid + \'&reply=\' + reply + \'& values=\' + values+ \'& checked=\' + checked ;

						    mui.ajax({
   				  					 type: \'POST\',
   				  					 url: "pendingapprovaltreat.php",
   				  					 data: postbody,
										 ...
										 {
     			  						       mui.openWindow({
     			  											 url: \'approvalrecord.php?type=treat\',
     			  											 id: \'info\'
     			  										 });
										 }
										 else
