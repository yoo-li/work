<?php /* Smarty version 2.6.18, created on 2017-08-16 11:23:32
         compiled from opinionrecord.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
            ...
            <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
 					<a class="mui-control-item iconfont icon-daishenpi button-color" href="pendingopiniontreat.php">&nbsp;发表意见</a> 
					<a class="mui-control-item iconfont icon-shenpijilu button-color mui-active" href="opinionrecord.php?type=treat">&nbsp;意见记录</a>
 				</div> 
            </div>
			<?php else: ?>
			<h1 class="mui-title">待我购物意见</h1>
            <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
 					<a class="mui-control-item iconfont icon-daishenpi button-color" href="pendingopinionorder.php">&nbsp;发表意见</a> 
					<a class="mui-control-item iconfont icon-shenpijilu button-color mui-active" href="opinionrecord.php?type=order">&nbsp;意见记录</a>
 				</div> 
            </div>
			<?php endif; ?>
		</header> 
...
<script type="text/javascript">
	...
	mui.ready(function ()
		  	...
		  	function order_html(v)
		  	{
		  		...
		  		sb.append(\'						<span class="mui-table-view-label">申请人：</span>\' + v.submitgivenname);
		  		sb.append(\'					</div>\');   
		  		sb.append(\'                </li>\');
		  		sb.append(\'				<li class="mui-table-view-cell">\');  
				if (v.opiniontype == \'treat\')
				{
				...
				else
				{
		  		...
		  		sb.append(\'								<p class="mui-ellipsis" style="color:#333">申请时间：\' + v.published + \'</p>\');
				sb.append(\'								<p class="mui-ellipsis" style="color:#333">意见提交时间：\' + v.submitdatetime + \'</p>\'); 
				sb.append(\'								<p class="mui-ellipsis" style="color:#333">意见：\' + v.opinion + \'</p>\');
				if( v.participants != null && v.estimatedcost!=null){
		  	...
		  	function order_empty_html()
		  	{
		  		...
		  		sb.append(\'					      <p class="msgbody">您还没有意见记录！<br>\');
	  			sb.append(\'							  <br> \');
				sb.append(\'						  </p>  \');
		  		sb.append(\' </div>\');
		  		return sb.toString();
		  	...
		  	function add_more()
		  	{
				...
				var type = Zepto(\'#type\').val(); 
		  		...
		  		mui.ajax({
		  					 type: \'POST\',
		  					 url: "opinionrecord.php",
		  					 data: \'type=ajax&opinion=\'+type+\'&page=\' + page,
