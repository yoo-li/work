<?php /* Smarty version 2.6.18, created on 2017-08-31 10:23:14
         compiled from treatrecord.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
            ...
            <div class="mui-title mui-content tit-sortbar" id="sortbar"> 
 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
 					<a class="mui-control-item iconfont icon-daishenpi button-color" href="treat.php">&nbsp;我要宴请</a> 
					<a class="mui-control-item iconfont icon-shenpijilu button-color mui-active" href="treatrecord.php">&nbsp;宴请记录</a>
 				</div> 
            </div> 
		</header> 
	...
	mui.ready(function ()
			  {
				  ...
				  mui(\'.mui-table-view\').on(\'tap\', \'a.submitorder\', function (e)
				  {
					  var treatid = this.getAttribute(\'data-id\');
					  mui.openWindow({
										 url: \'treatpayment.php?record=\'+treatid,
										 id: \'info\'
									 });
				  });
				  mui(\'.mui-table-view\').on(\'tap\', \'a.deleteorder\', function (e)
				  {
					  ...
					  swal({
						   ...
						   {
							   window.location.href = \'treatrecord.php?type=delete&record=\' + treatid;
						   });
				  });
			  }); 
		  	...
		  	function order_html(v)
		  	{
		  		...
		  		sb.append(\'						<span class="mui-table-view-label">宴请对象：</span>\' + v.treatobject);
			  	sb.append(\'					</div>\');  
				if (v.approvalstatus != "2" && v.approvalstatus != "1")
				{
					sb.append(\'					<div class="mui-media-body mui-pull-right"> \');
					sb.append(\'						<a class="mui-icon iconfont icon-quxiao deleteorder button-color myfont-color" data-id="\' + v.treatid + \'" href="#">&nbsp;取消宴请</a> \');
					sb.append(\'					</div> \');
			  		sb.append(\'                </li>\');
				}
		  		sb.append(\'				<li class="mui-table-view-cell">\');  
				sb.append(\'					 <a href="treatdetail.php?record=\' + v.treatid + \'" class="mui-navigate-right"> \');
	 		    sb.append(\'							<div class="mui-media-body">\');
		  		sb.append(\'								<p class="mui-ellipsis" style="color:#333">参与人员：\' + v.participants + \'</p>\'); 
				...
				sb.append(\'								<p class="mui-ellipsis" style="color:#333">人均消费：\' + v.percapita + \'</p>\');  
				sb.append(\'								<p class="mui-ellipsis" style="color:#333">宴请事由：\' + v.treatreason + \'</p>\');   
		  		sb.append(\'							</div> \'); 
				sb.append(\'					 </a>\');
		  		sb.append(\'				 </li> \');   
				sb.append(\'				 <li class="mui-table-view-cell order-link-cell"> \'); 
				sb.append(\'					<div class="mui-media-body  mui-pull-left">\');
				if(v.mall_officialtreatsstatus == \'Agree\'){
                    sb.append(\'						 <p class="mui-icon iconfont myfont-color" style="font-size: 14px;padding-left:55px;color:#cc3300;">状态：\' +\'已同意\'+ \'</p>\');
				}else if(v.mall_officialtreatsstatus == \'JustCreated\'){
                    sb.append(\'						 <p class="mui-icon iconfont myfont-color" style="font-size: 14px;padding-left:55px;color:#cc3300;">状态：\' +\'待审批\'+ \'</p>\');
			}else if( v.mall_officialtreatsstatus == \'Approvaling\'){
                    sb.append(\'						 <p class="mui-icon iconfont myfont-color" style="font-size: 14px;padding-left:55px;color:#cc3300;">状态：\' +\'审批中\'+ \'</p>\');
				}else {
                    sb.append(\'						 <p class="mui-icon iconfont myfont-color" style="font-size: 14px;padding-left:55px;color:#cc3300;">状态：\' + v.mall_officialtreatsstatus + \'</p>\');
				}


				sb.append(\'					</div> \');
				if (v.approvalstatus == "2" && v.treatpayment == \'0\')
				{
					if(v.mall_officialtreatsstatus != \'支付审批中\'){
					sb.append(\'<div class="mui-media-body mui-pull-right fenge">\');
					sb.append(\'<a class="mui-icon iconfont icon-feiyongshuomingicon submitorder button-color" data-id="\' + v.treatid + \'" href="#">&nbsp;去付款</a> \');
					sb.append(\'</div>\');
					}
				}
				sb.append(\'              </li>\');
		  	...
		  	function order_empty_html()
		  	{
		  		...
		  		sb.append(\'					      <p class="msgbody">您还没有宴请申请记录！<br>\');
	  			sb.append(\'							  <br> \');
				sb.append(\'						  </p>  \');
		  		sb.append(\' </div>\');
		  		return sb.toString();
