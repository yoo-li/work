...
<!--  
   ...
   #copyright .tezan {ldelim}font-size:10px;font-family:Arial Narrow,Arial; {rdelim} 
   #copyright .tezan a {ldelim}font-size:10px;font-family:Arial Narrow,Arial; {rdelim} 
-->
</style>
<div id="copyright" class="mui-card">
    <ul class="mui-table-view">
        <li class="mui-table-view-cell mui-media">  
                    <div class="mui-media-object mui-pull-left"><span class="mui-icon iconfont icon-logo menuicon" style="font-size: 3.0em;"></span></div>
                    <div class="mui-media-body">
                        <p class='mui-ellipsis'>湖南赛明威科技有限公司</p>
                        <p class='mui-ellipsis tezan'>Copyright © 2010-2016 <a href="http://www.tezan.cn">tezan.cn</a> All Rights Reserved.</span></p> 
                    </div> 
        </li>
